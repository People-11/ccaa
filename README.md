...
```bash
#amd
bash <(curl -Lsk https://raw.githubusercontent.com/People-11/ccaa/master/ccaa.sh)
#arm
bash <(curl -Lsk https://raw.githubusercontent.com/People-11/ccaa/master/ccaa.sh) arm
```
