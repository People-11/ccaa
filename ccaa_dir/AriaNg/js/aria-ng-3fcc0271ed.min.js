    ...
    angular.module("ariaNg").run(["$window", "$rootScope", "$location", "$document", "$timeout", "ariaNgCommonService", "ariaNgKeyboardService", "ariaNgNotificationService", "ariaNgLogService", "ariaNgSettingService", "aria2TaskService", function(a, n, s, o, e, t, i, r, l, c, d) {
        var u = !1
          ...
          , m = function() {
            if (c.isBrowserSupportDarkMode()) {
                ...
                l.info("[root.setThemeBySystemSettings] system uses " + (e.matches ? "dark" : "light") + " theme"),
                e.matches ? f() : g()
            } else
                g()
        }
        ...
        n.keydownActions = {
            find: function(e) {
                ...
                n.searchContext.setSearchBoxFocused(),
                !1
            }
        },
        n.swipeActions = {
            leftSwipe: function() {
                c.getSwipeGesture() && (angular.element("body").hasClass("sidebar-open") ? h() : (!this.extendLeftSwipe || angular.isFunction(this.extendLeftSwipe) && !this.extendLeftSwipe()) && h())
            },
            rightSwipe: function() {
                c.getSwipeGesture() && (!this.extendRightSwipe || angular.isFunction(this.extendRightSwipe) && !this.extendRightSwipe()) && angular.element("body").removeClass("sidebar-collapse").addClass("sidebar-open")
            }
        },
        ...
        n.setTheme = function(e) {
            "system" === e ? m() : "dark" === e ? f() : g()
        }
        ,
        a.addEventListener("keydown", function(e) {
            if (c.getKeyboardShortcuts()) {
                var t = angular.element('input[type="text"],textarea').is(":focus");
                if (i.isCtrlAPressed(e) && !t) {
                    if (angular.isFunction(n.keydownActions.selectAll))
                        return n.keydownActions.selectAll(e)
                } else if (i.isCtrlFPressed(e)) {
                    if (angular.isFunction(n.keydownActions.find))
                        return n.keydownActions.find(e)
                } else if (i.isDeletePressed(e) && !t && angular.isFunction(n.keydownActions.delete))
                    return n.keydownActions.delete(e)
            }
        }, !0),
        c.onFirstAccess(function() {
            r.notifyInPage("", "Tap to configure and get started with AriaNg.", {
                delay: !1,
                onClose: function() {
        ...
        d.onFirstSuccess(function(e) {
            r.notifyInPage("", "is connected", {
                type: "success",
                contentPrefix: e.rpcName + " "
            })
        }),
        d.onConnectionSuccess(function() {
            e(function() {
                "Connected" !== n.taskContext.rpcStatus && (n.taskContext.rpcStatus = "Connected")
            })
        }),
        d.onConnectionFailed(function() {
            e(function() {
                "Disconnected" !== n.taskContext.rpcStatus && (n.taskContext.rpcStatus = "Disconnected")
            })
        }),
        d.onConnectionReconnecting(function() {
            e(function() {
                "Reconnecting" !== n.taskContext.rpcStatus && (n.taskContext.rpcStatus = "Reconnecting")
            })
        }),
        d.onConnectionWaitingToReconnect(function() {
            e(function() {
                "Waiting to reconnect" !== n.taskContext.rpcStatus && (n.taskContext.rpcStatus = "Waiting to reconnect")
            })
        }),
        d.onTaskCompleted(function(e) {
            r.notifyTaskComplete(e.task)
        }),
        d.onBtTaskCompleted(function(e) {
            r.notifyBtTaskComplete(e.task)
        }),
        d.onTaskErrorOccur(function(e) {
            r.notifyTaskError(e.task)
        }),
        n.$on("$locationChangeStart", function(e) {
            t.closeAllDialogs(),
            n.loadPromise = null,
            delete n.keydownActions.selectAll,
            delete n.keydownActions.delete,
        ...
        c.isBrowserSupportDarkMode()) && a.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", function(e) {
            l.info("[root] system switches to " + (e.matches ? "dark" : "light") + " theme"),
            "system" === c.getTheme() && (e.matches ? f() : g())
        });
        n.$on("$locationChangeSuccess", function(e, t) {
            u && a.location.reload()
        }),
        "system" === c.getTheme() ? m() : "dark" === c.getTheme() ? f() : g(),
        function() {
            var e = c.getBrowserFeatures();
            if (e.localStroage || l.warn("[root.initCheck] LocalStorage is not supported!"),
            e.cookies || l.warn("[root.initCheck] Cookies is not supported!"),
            !c.isBrowserSupportStorage())
                ...
                r.notifyInPage("", "You cannot use AriaNg because this browser does not meet the minimum requirements for data storage.", {
                    type: "error",
                    delay: !1
                }),
...
function() {
    ...
    angular.module("ariaNg").constant("ariaNgConstants", {
        ...
        secret: "",
        extendRpcServers: [],
        webSocketReconnectInterval: 5e3,
...
function() {
    ...
    angular.module("ariaNg").config(["$qProvider", "$translateProvider", "localStorageServiceProvider", "NotificationProvider", "ariaNgConstants", "ariaNgLanguages", function(e, t, a, n, i, s) {
        ...
        t.useLoader("ariaNgLanguageLoader").useLoaderCache(!0).registerAvailableLanguageKeys(o, r).fallbackLanguage(i.defaultLanguage).useSanitizeValueStrategy("escapeParameters"),
        n.setOptions({
...
function() {
    ...
    angular.module("ariaNg").controller("CommandController", ["$rootScope", "$window", "$location", "$routeParams", "ariaNgDefaultOptions", "ariaNgCommonService", "ariaNgLogService", "ariaNgSettingService", "aria2TaskService", "aria2SettingService", function(s, o, r, e, l, c, d, u, p, g) {
        var t, a, n = r.path(), i = angular.extend({}, e, r.search());
        a = i,
        (0 === (t = n).indexOf("/new") ? function(e, t) {
            try {
                e = c.base64UrlDecode(e)
            } catch (e) {
                return c.showError("URL is not base64 encoded!"),
                !1
            }
            var a = {}
              , n = !1;
            ...
            return s.loadPromise = p.newUriTask({
                urls: [e],
                options: a
            }, n, function(e) {
                if (!e.success)
            ...
            d.info("[CommandController] new download: " + e),
            !0
        }(a.url, a) : 0 === t.indexOf("/settings/rpc/set") ? function(e, t, a, n, i) {
            if (a = a || l.rpcPort,
            n = n || l.rpcInterface,
            i = i || l.secret,
            d.info("[CommandController] set rpc: " + e + "://" + t + ":" + a + "/" + n + ", secret: " + i),
            !e || "http" !== e && "https" !== e && "ws" !== e && "wss" !== e)
                return c.showError("Protocol is invalid!"),
                !1;
            if (!t)
                return c.showError("RPC host cannot be empty!"),
                !1;
            if (i)
                try {
                    i = c.base64UrlDecode(i)
                } catch (e) {
                    return c.showError("RPC secret is not base64 encoded!"),
                    !1
                }
            var s = {
                rpcAlias: "",
            ...
            return u.isRpcSettingEqualsDefault(s) ? r.path("/downloading") : (u.setDefaultRpcSetting(s, {
                keepCurrent: !1,
                forceSet: !0
            }),
            r.path("/downloading"),
            o.location.reload()),
            !0
        }(a.protocol, a.host, a.port, a.interface, a.secret) : (c.showError("Parameter is invalid!"),
        0)) || r.path("/downloading")
    }
    ])
}(),
function() {
    ...
    angular.module("ariaNg").controller("AriaNgDebugController", ["$rootScope", "$scope", "$location", "$interval", "$timeout", "$filter", "ariaNgConstants", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgKeyboardService", "ariaNgSettingService", "aria2RpcService", function(t, s, e, a, n, o, i, r, l, c, d, u, p) {
        var g = [{
          ...
          , m = function() {
            for (var e = [], t = 0; t < g.length; t++)
                g[t].show && e.push(g[t].name);
            return e
        };
        s.context = {
            currentTab: "logs",
            logMaxCount: i.cachedDebugLogsLimit,
            logAutoRefreshAvailableInterval: r.getTimeOptions([100, 200, 500, 1e3, 2e3], !0),
            logAutoRefreshInterval: 1e3,
        ...
        s.enableDebugMode = function() {
            return u.isEnableDebugMode()
        }
        ,
        s.changeTab = function(e) {
            "rpc" === e && (t.loadPromise = function() {
                if (!s.context.availableRpcMethods || !s.context.availableRpcMethods.length)
                    return p.listMethods({
                        silent: !1,
                        callback: function(e) {
                            e.success && (s.context.availableRpcMethods = e.data)
                        }
                    })
            }()),
            s.context.currentTab = e
        }
        ,
        s.changeLogListDisplayOrder = function(e) {
            var t = r.parseOrderType(s.context.logListDisplayOrder)
              , a = r.parseOrderType(e);
            a.type === t.type && (a.reverse = !t.reverse),
            s.context.logListDisplayOrder = a.getValue()
        }
        ,
        ...
        ,
        s.getLogListOrderType = function() {
            return s.context.logListDisplayOrder
        }
        ,
        s.filterLog = function(e) {
            return !(!e || !angular.isString(e.level)) && (!s.context.logLevelFilter || 0 <= c.compareLogLevel(e.level, s.context.logLevelFilter))
        }
        ,
        s.setLogLevelFilter = function(e) {
            s.context.logLevelFilter = e
        }
        ,
        s.isSetLogLevelFilter = function(e) {
            return s.context.logLevelFilter === e
        }
        ,
        s.getLogLevelFilter = function() {
            return s.context.logLevelFilter
        }
        ,
        s.setAutoRefreshInterval = function(e) {
            s.context.logAutoRefreshInterval = e,
            f && a.cancel(f),
            0 < e && (s.reloadLogs(),
            f = a(function() {
                s.reloadLogs()
            }, s.context.logAutoRefreshInterval))
        }
        ,
        s.reloadLogs = function() {
            s.context.logs = c.getDebugLogs().slice()
        }
        ,
        s.clearDebugLogs = function() {
            r.confirm("Confirm Clear", "Are you sure you want to clear debug logs?", "warning", function() {
                c.clearDebugLogs(),
                s.reloadLogs()
            }, !1)
        }
        ,
        s.showLogDetail = function(e) {
            s.context.currentLog = e,
            angular.element("#log-detail-modal").modal()
        }
        ,
        $("#log-detail-modal").on("hide.bs.modal", function(e) {
            s.context.currentLog = null
        }),
        s.executeAria2Method = function() {
            if (!s.context.rpcRequestMethod || s.context.rpcRequestMethod.indexOf(".") < 0)
                r.showError("RPC method is illegal!");
            else {
                ...
                if (2 === e.length) {
                    ...
                    if (angular.isFunction(p[t])) {
                        var a = {
                            silent: !1,
                            callback: function(e) {
                                s.context.rpcResponse = e ? o("json")(e.data) : o("json")(e)
                            }
                        }
                          , n = {};
                        try {
                            n = angular.fromJson(s.context.rpcRequestParameters)
                        } catch (e) {
                            return c.error("[AriaNgDebugController.executeAria2Method] failed to parse request parameters: " + s.context.rpcRequestParameters, e),
                            void r.showError("RPC request parameters are invalid!")
                        }
                        for (var i in n)
                            n.hasOwnProperty(i) && "silent" !== i && "callback" !== i && (a[i] = n[i]);
                        return p[t](a)
                    }
        ...
        ,
        s.requestParametersTextboxKeyDown = function(e) {
            if (u.getKeyboardShortcuts())
                return d.isCtrlEnterPressed(e) && s.executeMethodForm.$valid ? (e.preventDefault && e.preventDefault(),
                s.executeAria2Method(),
                !1) : void 0
        }
        ,
        ...
        t.swipeActions.extendLeftSwipe = function() {
            ...
            return t < e.length - 1 && (s.changeTab(e[t + 1]),
            !0)
        }
        ,
        t.swipeActions.extendRightSwipe = function() {
            var e = m()
              , t = e.indexOf(s.context.currentTab);
            return 0 < t && (s.changeTab(e[t - 1]),
            !0)
        }
        ,
        t.loadPromise = n(function() {
            u.isEnableDebugMode() ? s.setAutoRefreshInterval(s.context.logAutoRefreshInterval) : r.showError("Access Denied!", function() {
                u.isEnableDebugMode() || e.path("/settings/ariang")
            })
        }, 100)
    }
    ])
...
function() {
    ...
    angular.module("ariaNg").controller("MainController", ["$rootScope", "$scope", "$route", "$window", "$location", "$document", "$interval", "clipboard", "aria2RpcErrors", "ariaNgCommonService", "ariaNgVersionService", "ariaNgNotificationService", "ariaNgSettingService", "ariaNgMonitorService", "ariaNgTitleService", "aria2TaskService", "aria2SettingService", function(i, s, o, t, r, a, n, l, c, d, e, u, p, g, f, m, h) {
        var v = null
          , b = null
          , y = function() {
            var e = f.getFinalTitleByGlobalStat({
        ...
        p.getBrowserNotification() && u.requestBrowserPermission(),
        s.ariaNgVersion = e.getBuildVersion(),
        s.globalStatusContext = {
            isEnabled: 0 < p.getGlobalStatRefreshInterval(),
        ...
        s.rpcSettings = p.getAllRpcSettings(),
        s.currentRpcProfile = w(),
        s.isCurrentRpcUseWebSocket = p.isCurrentRpcUseWebSocket(),
        ...
        s.changeTasksState = function(t) {
            ...
            if (a && !(a.length < 1)) {
                ...
                i.loadPromise = e(a, function(e) {
                    e.hasError && 1 < a.length && d.showError("Failed to change some tasks state."),
                    e.hasSuccess && (k(!0),
                    e.hasError || "start" !== t ? e.hasError || "pause" !== t || ("/downloading" === r.path() ? r.path("/waiting") : o.reload()) : "/waiting" === r.path() ? r.path("/downloading") : o.reload())
                }, 1 < a.length)
            }
        }
        ,
            ...
            d.confirm("Confirm Retry", "Are you sure you want to retry the selected task? AriaNg will create same task after clicking OK.", "info", function() {
                i.loadPromise = m.retryTask(e.gid, function(e) {
                    if (e.success) {
                        ...
                        d.showError("Failed to retry this task.")
                }, !1)
            })
        }
        ,
            ...
            if (e && !(e.length < 1)) {
                ...
                d.confirm("Confirm Retry", "Are you sure you want to retry the selected task? AriaNg will create same task after clicking OK.", "info", function() {
                    i.loadPromise = m.retryTasks(t, function(t) {
                        k(!0),
                        d.showInfo("Operation Result", "{successCount} tasks have been retried and {failedCount} tasks are failed.", function() {
        ...
        s.removeTasks = function() {
            ...
            if (t && !(t.length < 1)) {
                var e = function() {
                    i.loadPromise = m.removeTasks(t, function(e) {
                        e.hasError && 1 < t.length && d.showError("Failed to remove some task(s)."),
                        e.hasSuccess && (k(!0),
                        e.hasError || ("/stopped" !== r.path() ? r.path("/stopped") : o.reload()))
                    }, 1 < t.length)
                };
        ...
        s.clearStoppedTasks = function() {
            d.confirm("Confirm Clear", "Are you sure you want to clear stopped tasks?", "warning", function() {
                i.loadPromise = m.clearStoppedTasks(function(e) {
                    e.success && (k(!0),
        ...
        s.changeDisplayOrder = function(e, t) {
            var a = d.parseOrderType(p.getDisplayOrder())
        ...
        s.isSetDisplayOrder = function(e) {
            var t = d.parseOrderType(p.getDisplayOrder())
        ...
        s.switchRpcSetting = function(e) {
            ...
            0 === r.path().indexOf("/task/detail/") ? (i.setAutoRefreshAfterPageLoad(),
            r.path("/downloading")) : t.location.reload())
        }
        ,
        0 < p.getTitleRefreshInterval() && (v = n(function() {
            y()
        }, p.getTitleRefreshInterval())),
        0 < p.getGlobalStatRefreshInterval() && (b = n(function() {
            k(!0)
...
function() {
    ...
    angular.module("ariaNg").controller("NewTaskController", ["$rootScope", "$scope", "$location", "$timeout", "ariaNgCommonService", "ariaNgLogService", "ariaNgKeyboardService", "ariaNgFileService", "ariaNgSettingService", "aria2TaskService", "aria2SettingService", function(g, f, m, e, i, t, a, n, h, v, s) {
        var o, r = [{
            ...
            name: "options",
            show: !0
        }], l = m.search(), c = function() {
            for (var e = [], t = 0; t < r.length; t++)
                r[t].show && e.push(r[t].name);
            return e
        }, b = function(e) {
            e && e.dir && s.addSettingHistory("dir", e.dir)
        }, y = function(e) {
        ...
        if (f.context = {
            ...
            urls: "",
            uploadFile: null,
            availableOptions: (o = s.getNewTaskOptionKeys(),
            s.getSpecifiedOptions(o, {
                disableRequired: !0
            })),
            globalOptions: null,
            options: {},
        ...
        l.url)
            try {
                f.context.urls = i.base64UrlDecode(l.url)
            } catch (e) {
                t.error("[NewTaskController] base64 decode error, url=" + l.url, e)
            }
        f.changeTab = function(e) {
            "options" === e && f.loadDefaultOption(),
            f.context.currentTab = e
        }
        ,
        g.swipeActions.extendLeftSwipe = function() {
            var e = c()
              , t = e.indexOf(f.context.currentTab);
            return t < e.length - 1 && (f.changeTab(e[t + 1]),
            !0)
        }
        ,
        g.swipeActions.extendRightSwipe = function() {
            var e = c()
              , t = e.indexOf(f.context.currentTab);
            return 0 < t && (f.changeTab(e[t - 1]),
            !0)
        }
        ,
        f.loadDefaultOption = function() {
            f.context.globalOptions || (g.loadPromise = s.getGlobalOption(function(e) {
                e.success && (f.context.globalOptions = e.data)
            }))
        }
        ,
        f.openTorrent = function() {
            n.openFileContent({
                scope: f,
                fileFilter: ".torrent",
                fileType: "binary"
            }, function(e) {
                f.context.uploadFile = e,
                f.context.taskType = "torrent",
                f.changeTab("options")
            }, function(e) {
                i.showError(e)
        ...
        ,
        f.isNewTaskValid = function() {
            return !!f.context.uploadFile || f.newTaskForm.$valid
        }
        ,
        f.startDownload = function(a) {
            var e, t, n, i, s, o, r, l, c, d, u, p = function(e) {
                if (e.hasSuccess || e.success) {
                    var t = null;
                    e.results && 0 < e.results.length ? t = e.results[0] : e && (t = e),
                    "task-detail" === h.getAfterCreatingNewTask() && t && t.data ? m.path("/task/detail/" + t.data) : a ? m.path("/waiting") : m.path("/downloading")
                }
            };
            "urls" === f.context.taskType ? g.loadPromise = (l = a,
            c = p,
            d = angular.copy(f.context.options),
            u = y(d),
            b(d),
            v.newUriTasks(u, l, c)) : "torrent" === f.context.taskType ? g.loadPromise = (i = a,
            s = p,
            o = angular.copy(f.context.options),
            r = {
                content: f.context.uploadFile.base64Content,
                options: o
            },
            b(r.options),
            v.newTorrentTask(r, i, s)) : "metalink" === f.context.taskType && (g.loadPromise = (e = a,
            t = p,
            n = {
                content: f.context.uploadFile.base64Content,
                options: angular.copy(f.context.options)
            },
            b(n.options),
            v.newMetalinkTask(n, e, t)))
        }
        ,
        f.showExportCommandAPIModal = function() {
            f.context.exportCommandApiOptions = {
                type: "new-task",
                data: y()
            }
        }
        ...
        f.setOption = function(e, t, a) {
            "" !== t ? f.context.options[e] = t : delete f.context.options[e],
            a.setReady()
        }
        ,
        f.urlTextboxKeyDown = function(e) {
            if (h.getKeyboardShortcuts())
                return a.isCtrlEnterPressed(e) && f.newTaskForm.$valid ? (e.preventDefault && e.preventDefault(),
                f.startDownload(),
                !1) : void 0
        }
        ,
        f.getValidUrlsCount = function() {
            var e = i.parseUrlsFromOriginInput(f.context.urls);
            return e ? e.length : 0
        }
        ,
        g.loadPromise = e(function() {}, 100)
    }
    ])
}(),
function() {
    ...
    angular.module("ariaNg").controller("DownloadListController", ["$rootScope", "$scope", "$window", "$location", "$route", "$interval", "dragulaService", "aria2RpcErrors", "ariaNgCommonService", "ariaNgSettingService", "aria2TaskService", function(o, t, e, a, n, r, i, l, c, s, d) {
                ...
                return d.getTaskList(u, f, function(e) {
                    if (!g)
                        if (e.success) {
                            ...
                            if (o.taskContext.list && 0 < o.taskContext.list.length && (d.processDownloadTasks(o.taskContext.list),
                            !t)) {
                                var i = !1;
                                ...
                                if (!i)
                                    return f = !0,
                                    void (o.taskContext.list.length = 0)
                            }
        ...
        ,
        0 < s.getDownloadTaskRefreshInterval() && (p = r(function() {
            m(!0)
        }, s.getDownloadTaskRefreshInterval())),
        i.options(t, "task-list", {
            revertOnSpill: !0,
            moves: function() {
        ...
        o.keydownActions.selectAll = function(e) {
            return e.preventDefault && e.preventDefault(),
            t.$apply(function() {
                t.selectAllTasks()
            }),
        ...
        ,
        o.keydownActions.delete = function(e) {
            return e.preventDefault && e.preventDefault(),
            t.$apply(function() {
                t.removeTasks()
            }),
...
function() {
    ...
    angular.module("ariaNg").controller("TaskDetailController", ["$rootScope", "$scope", "$routeParams", "$interval", "clipboard", "aria2RpcErrors", "ariaNgFileTypes", "ariaNgCommonService", "ariaNgSettingService", "ariaNgMonitorService", "aria2TaskService", "aria2SettingService", function(o, g, e, t, n, a, f, m, r, l, s, c) {
        var i = [{
          ...
          , b = function(e) {
            var t, a, n, i, s;
            e && (g.context.showPiecesInfo = (t = e,
            a = r.getShowPiecesInfoInTaskDetailPage(),
            !(!t || "never" === a) && ("le102400" === a ? t.numPieces <= 102400 : "le10240" === a ? t.numPieces <= 10240 : "le1024" !== a || t.numPieces <= 1024)),
            v("pieces", g.context.showPiecesInfo),
            v("btpeers", "active" === e.status && e.bittorrent),
            g.task && g.task.status === e.status || (g.context.availableOptions = (n = e.status,
            i = !!e.bittorrent,
            s = c.getAvailableTaskOptionKeys(n, i),
            c.getSpecifiedOptions(s, {
                disableRequired: !0
            }))),
          ...
          , w = function(a) {
            if (!u) {
                ...
                return g.task ? s.getTaskStatusAndBtPeers(e.gid, function(e) {
                    ...
                    var t = e.data;
                    b(t),
                    k(t) && s.getBtTaskPeers(t, function(e) {
                        e.success && y(e.data)
                    }, a, !0)
                }, a, !0)
            }
          ...
          , S = function(e) {
            if (g.task && g.task.files) {
                ...
                return u = !0,
                s.selectTaskFile(t, a, function(e) {
                    u = !1,
                    e.success && w(!1)
                }, e)
            }
        ...
        o.swipeActions.extendLeftSwipe = function() {
            ...
            return t < e.length - 1 && (g.changeTab(e[t + 1]),
            !0)
        }
        ,
        ...
        g.saveChoosedFiles = function() {
            g.context.showChooseFilesToolbar && (o.loadPromise = S(!1),
            g.context.showChooseFilesToolbar = !1)
        }
        ,
        g.cancelChooseFiles = function() {
            g.context.showChooseFilesToolbar && (w(!(u = !1)),
            g.context.showChooseFilesToolbar = !1)
        }
        ,
        ...
        g.setSelectedFile = function(e) {
            e && C(),
            g.context.showChooseFilesToolbar || S(!0)
        }
        ,
        ...
        g.setOption = function(e, t, a) {
            return s.setTaskOption(g.task.gid, e, t, function(e) {
        ...
        ,
        0 < r.getDownloadTaskRefreshInterval() && (d = t(function() {
...
function() {
    ...
    angular.module("ariaNg").controller("AriaNgSettingsController", ["$rootScope", "$scope", "$routeParams", "$window", "$interval", "$timeout", "$filter", "clipboard", "ariaNgLanguages", "ariaNgCommonService", "ariaNgVersionService", "ariaNgKeyboardService", "ariaNgNotificationService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgFileService", "ariaNgSettingService", "ariaNgMonitorService", "ariaNgTitleService", "aria2SettingService", function(t, n, e, a, i, s, o, r, l, c, d, u, p, g, f, m, h, v, b, y) {
        var k = e.extendType
          , w = null
          , S = function() {
            return b.getFinalTitleByGlobalStat({
                globalStat: v.getCurrentGlobalStat(),
                currentRpcProfile: x()
            })
        }
          , x = function() {
          ...
          , T = function() {
            w || (w = p.notifyInPage("", "Configuration has been modified, please reload the page for the changes to take effect.", {
                delay: !1,
                type: "info",
        ...
        n.context = {
            currentTab: "global",
            ariaNgVersion: d.getBuildVersion(),
            buildCommit: d.getBuildCommit(),
            languages: l,
            titlePreview: S(),
            ...
            showRpcSecret: !1,
            isInsecureProtocolDisabled: h.isInsecureProtocolDisabled(),
            settings: h.getAllOptions(),
            sessionSettings: h.getAllSessionOptions(),
            rpcSettings: h.getAllRpcSettings(),
            isMacKeyboardLike: u.isMacKeyboardLike(),
            isSupportReconnect: y.canReconnect(),
            isSupportBlob: m.isSupportBlob(),
            isSupportDarkMode: h.isBrowserSupportDarkMode(),
            importSettings: null,
            exportSettings: null,
            exportSettingsCopied: !1,
            exportCommandApiOptions: null
        },
        n.context.titlePreview = S(),
        n.context.showDebugMode = n.context.sessionSettings.debugMode || "debug" === k,
        ...
        n.isSupportNotification = function() {
            return p.isSupportBrowserNotification() && h.isCurrentRpcUseWebSocket(n.context.settings.protocol)
        }
        ,
        n.setLanguage = function(e) {
            h.setLanguage(e) && g.applyLanguage(e),
        ...
        n.setEnableBrowserNotification = function(e) {
            h.setBrowserNotification(e),
            e && !p.hasBrowserPermission() && p.requestBrowserPermission(function(e) {
                e.granted || (n.context.settings.browserNotification = !1,
                c.showError("You have disabled notification in your browser. You should change your browser's settings before you enable this function."))
            })
        }
        ,
        n.setBrowserNotificationSound = function(e) {
            h.setBrowserNotificationSound(e)
        }
        ,
        n.setBrowserNotificationFrequency = function(e) {
            h.setBrowserNotificationFrequency(e)
        }
        ,
        n.setWebSocketReconnectInterval = function(e) {
            T(),
            h.setWebSocketReconnectInterval(e)
        }
        ,
        n.setTitleRefreshInterval = function(e) {
            T(),
            h.setTitleRefreshInterval(e)
        }
        ,
        n.setGlobalStatRefreshInterval = function(e) {
            T(),
            h.setGlobalStatRefreshInterval(e)
        }
        ,
        n.setDownloadTaskRefreshInterval = function(e) {
            T(),
            h.setDownloadTaskRefreshInterval(e)
        }
        ,
        n.setRPCListDisplayOrder = function(e) {
            T(),
            h.setRPCListDisplayOrder(e)
        }
        ,
        n.setKeyboardShortcuts = function(e) {
            h.setKeyboardShortcuts(e)
        }
        ,
        ...
        n.importSettings = function(e) {
            ...
            try {
                ...
                void c.showError("Invalid settings data format!")
            }
            if (!angular.isObject(t) || angular.isArray(t))
                ...
                void c.showError("Invalid settings data format!");
            t && c.confirm("Confirm Import", "Are you sure you want to import all settings?", "warning", function() {
                h.importAllOptions(t),
                a.location.reload()
            })
        }
        ,
        n.showExportSettingsModal = function() {
            n.context.exportSettings = o("json")(h.exportAllOptions()),
        ...
        ,
        n.showExportCommandAPIModal = function(e) {
            n.context.exportCommandApiOptions = {
                type: "setting",
                data: e
            }
        }
        ...
        n.setDefaultRpcSetting = function(e) {
            e.isDefault || (h.setDefaultRpcSetting(e),
            a.location.reload())
        }
        ,
        n.resetSettings = function() {
            c.confirm("Confirm Reset", "Are you sure you want to reset all settings?", "warning", function() {
                h.resetSettings(),
                a.location.reload()
            })
        }
        ...
        n.clearHistory = function() {
            c.confirm("Confirm Clear", "Are you sure you want to clear all settings history?", "warning", function() {
                y.clearSettingsHistorys(),
                a.location.reload()
            })
        }
        ,
...
function() {
    "use strict";
    angular.module("ariaNg").controller("Aria2StatusController", ["$rootScope", "$scope", "$timeout", "ariaNgCommonService", "ariaNgSettingService", "aria2SettingService", function(e, t, a, n, i, s) {
        t.context = {
            host: i.getCurrentRpcUrl(),
            serverStatus: null,
            isSupportReconnect: s.canReconnect()
        },
        t.reconnect = function() {
            !t.context.isSupportReconnect || "Disconnected" !== e.taskContext.rpcStatus && "Waiting to reconnect" !== e.taskContext.rpcStatus || s.reconnect()
        }
        ,
        t.saveSession = function() {
            return s.saveSession(function(e) {
                e.success && "OK" === e.data && n.showOperationSucceeded("Session has been saved successfully.")
            })
        }
        ,
        t.shutdown = function() {
            n.confirm("Confirm Shutdown", "Are you sure you want to shutdown aria2?", "warning", function(e) {
                return s.shutdown(function(e) {
                    e.success && "OK" === e.data && n.showOperationSucceeded("Aria2 has been shutdown successfully.")
                })
            }, !0)
        }
        ,
        e.$watch("taskContext.rpcStatus", function(e) {
            "Connected" === e ? s.getAria2Status(function(e) {
                e.success && (t.context.serverStatus = e.data)
            }) : t.context.serverStatus = null
        }),
        e.loadPromise = a(function() {}, 100)
    }
    ])
}(),
function() {
            ...
            link: function(c, d) {
                var e = function() {
                    ...
                    for (var n = 0, i = e.width, s = e.height, o = 0; o < t.length; o++) {
                        ...
                        r.isCompleted && a.fillRect(n, 0, l, s),
                        n += l
                    }
                };
                    ...
                    !function() {
                        ...
                        if (o && e && o.length === e.length && e.length === s.length) {
                            for (var t = 0; t < s.length; t++)
                                o[t] !== e[t] && (e[t] ? s[t].addClass("piece-completed") : s[t].removeClass("piece-completed"));
                            o = e
                        } else
                            a()
                    }()
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngExportCommandApiDialog", ["clipboard", "ariaNgCommonService", function(a, s) {
        return {
            restrict: "E",
            ...
            link: function(n, t, e) {
                n.context = {
                    ...
                    baseUrl: s.getFullPageUrl(),
                    commandAPIUrl: null,
                    pauseOnAdded: !0,
                    isCopied: !1
                };
                var i = function(e) {
                    var t = n.context.baseUrl + "#!/new/task?url=" + s.base64UrlEncode(e.urls[0]);
                    if (n.context.pauseOnAdded && (t += "&pause=true"),
                    e.options)
                        for (var a in e.options)
                            e.options.hasOwnProperty(a) && (t += "&" + a + "=" + e.options[a]);
                    return t
                };
                n.generateCommandAPIUrl = function() {
                    var e, t;
                    n.options && ("new-task" === n.options.type ? n.context.commandAPIUrl = function(e) {
                        for (var t = "", a = 0; a < e.length; a++)
                            0 < a && (t += "\n"),
                            t += i(e[a]);
                        return t
                    }(n.options.data) : "setting" === n.options.type && (n.context.commandAPIUrl = (e = n.options.data,
                    t = n.context.baseUrl + "#!/settings/rpc/set?protocol=" + e.protocol + "&host=" + e.rpcHost + "&port=" + e.rpcPort + "&interface=" + e.rpcInterface,
                    e.secret && (t += "&secret=" + s.base64UrlEncode(e.secret)),
                    t)),
                    n.context.isCopied = !1)
                }
                ,
                n.copyCommandAPI = function() {
                    a.copyText(n.context.commandAPIUrl, {
                        container: angular.element(t)[0]
                    }),
                    n.context.isCopied = !0
                }
                ,
                angular.element(t).on("hidden.bs.modal", function() {
                    n.$apply(function() {
                        n.options = null,
                        n.context.commandAPIUrl = null,
                        n.context.isCopied = !1
                    })
                }),
                n.$watch("options", function(e) {
                    e && (n.generateCommandAPIUrl(),
                    n.context.isCopied = !1,
                    angular.element(t).modal("show"))
                }, !0)
            }
        }
    }
        ...
        return {
            ...
            link: function(n, i, e) {
                ...
                n.setGlobalOption = function(e, t, a) {
                    return o.setGlobalOption(e, t, function(e) {
                        e.success && "OK" === e.data ? a.setSuccess() : a.setFailed(e.data.message)
                    }, !0)
                }
                ;
                angular.element(i).on("hidden.bs.modal", function() {
                    n.$apply(function() {
                        n.setting = null,
                ...
                n.$watch("setting", function(e) {
                    var t, a;
                    e && (t = e.type,
                    (a = o.getAria2QuickSettingsAvailableOptions(t)) ? n.context.availableOptions = o.getSpecifiedOptions(a) : s.showError("Type is illegal!"),
                    n.context.isLoading = !0,
                    o.getGlobalOption(function(e) {
                        n.context.isLoading = !1,
                        e.success && (n.context.globalOptions = e.data)
                    }),
                    angular.element(i).modal("show"))
                }, !0)
            }
        }
    }
...
function() {
    "use strict";
    angular.module("ariaNg").filter("logOrderBy", ["$filter", "ariaNgCommonService", function(n, i) {
        return function(e, t) {
            if (!angular.isArray(e) || !t)
                return e;
            var a = i.parseOrderType(t);
            return null === a ? e : "time" === a.type ? n("orderBy")(e, ["time"], a.reverse) : e
        }
    }
    ])
}(),
...
function() {
    "use strict";
    angular.module("ariaNg").filter("timeDisplayName", ["ariaNgCommonService", "ariaNgLocalizationService", function(n, i) {
        return function(e, t) {
            if (!e)
                return i.getLocalizedText(t);
            var a = n.getTimeOption(e);
            return i.getLocalizedText(a.name, {
                value: a.value
            })
        }
    }
    ...
    angular.module("ariaNg").factory("ariaNgLanguageLoader", ["$http", "$q", "ariaNgConstants", "ariaNgLanguages", "ariaNgAssetsCacheService", "ariaNgNotificationService", "ariaNgLogService", "ariaNgStorageService", function(o, r, l, c, d, u, p, g) {
        ...
        return function(t) {
            ...
            d.getLanguageAsset(t.key)) {
                var e = h(d.getLanguageAsset(t.key));
                return g.set(i, e),
                n.resolve(e),
                n.promise
            }
            ...
            return o({
                ...
                return s && (a = !v(s, t)),
                g.set(i, t),
                a ? (p.info("[ariaNgLanguageLoader] load language resource successfully, and resource is updated"),
                u.notifyInPage("", "Language resource has been updated, please reload the page for the changes to take effect.", {
                    delay: !1,
                    type: "info",
                    templateUrl: "views/notification-reloadable.html"
                })) : p.info("[ariaNgLanguageLoader] load language resource successfully, but resource is not updated"),
                n.resolve(t)
            }).catch(function(e) {
...
function() {
    ...
    angular.module("ariaNg").factory("ariaNgCommonService", ["$window", "$location", "$timeout", "base64", "moment", "SweetAlert", "ariaNgConstants", "ariaNgLocalizationService", function(e, t, d, a, n, u, i, p) {
        var o = function(e) {
            var t = e;
            return {
                name: e < 1e3 ? 1 === (t = e) ? "format.time.millisecond" : "format.time.milliseconds" : e < 6e4 ? 1 === (t = e / 1e3) ? "format.time.second" : "format.time.seconds" : e < 144e4 ? 1 === (t = e / 1e3 / 60) ? "format.time.minute" : "format.time.minutes" : 1 === (t = e / 1e3 / 60 / 24) ? "format.time.hour" : "format.time.hours",
                value: t,
                optionValue: e
            }
        };
        return {
            getFullPageUrl: function() {
                return e.location.protocol + "//" + e.location.host + e.location.pathname + (e.location.search ? e.location.search : "")
            },
            ...
            generateUniqueId: function() {
                var e = i.appPrefix + "_" + Math.round((new Date).getTime() / 1e3) + "_" + Math.random();
                return this.base64Encode(e)
            },
            showDialog: function(e, t, a, n, i) {
                var s, o, r, l, c;
                i || (i = {}),
                e && (e = p.getLocalizedText(e)),
                t && (t = p.getLocalizedText(t, i.textParams)),
                i.confirmButtonText = p.getLocalizedText("OK"),
                s = e,
                o = t,
                r = a,
                l = n,
                ...
                d(function() {
                    u.swal({
                        ...
                        text: o,
                        type: r,
                        confirmButtonText: c && c.confirmButtonText || null
                    }, function() {
                        l && l()
                    })
                }, 100)
            ...
            showError: function(e, t, a) {
                this.showDialog("Error", e, "error", t, a)
            },
            ...
            confirm: function(e, t, a, n, i, s) {
                ...
                s || (s = {}),
                e && (e = p.getLocalizedText(e)),
                t && (t = p.getLocalizedText(t, s.textParams)),
                s.confirmButtonText = p.getLocalizedText("OK"),
                s.cancelButtonText = p.getLocalizedText("Cancel"),
                r = n,
                d = {
                    title: e,
                    text: t,
                    type: o = a,
                    showCancelButton: !0,
                    showLoaderOnConfirm: !!(l = i),
                    closeOnConfirm: !l,
                    confirmButtonText: (c = s) && c.confirmButtonText || null,
                    cancelButtonText: c && c.cancelButtonText || null
                },
                "warning" === o && (d.confirmButtonColor = "#F39C12"),
                u.swal(d, function(e) {
                    e && r && r()
                })
            },
            ...
            isUnixTimeAfter: function(e, t, a) {
                return n(e, "X").isAfter(n().add(t, a))
            },
            formatDateTime: function(e, t) {
                return n(e).format(t)
            },
            getTimeOption: function(e) {
                return o(e)
            },
...
function() {
    ...
    angular.module("ariaNg").factory("ariaNgKeyboardService", ["$window", function(e) {
        ...
        return {
            ...
            isCtrlAPressed: function(e) {
                return n(e) && ("KeyA" === e.code || 65 === i(e))
            },
            isCtrlFPressed: function(e) {
                return n(e) && ("KeyF" === e.code || 70 === i(e))
            },
            isCtrlEnterPressed: function(e) {
                return n(e) && ("Enter" === e.code || 13 === i(e))
            },
            isDeletePressed: function(e) {
                return "Delete" === e.code || 46 === i(e)
            }
        }
    }
    ])
...
function() {
    ...
    angular.module("ariaNg").factory("ariaNgNotificationService", ["$window", "Notification", "ariaNgConstants", "ariaNgCommonService", "ariaNgStorageService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", function(n, o, i, s, r, l, c, d) {
        var u = !!n.Notification
          ...
          , a = function() {
            return n.Notification ? n.Notification.permission : null
        }
          , g = function(e, t) {
            n.Notification && p(a()) && (function() {
                ...
                if ("high" === d.getBrowserNotificationFrequency()) {
                    if (e.length < 10)
                        return !1;
                    t = e[e.length - 10].time,
                    a = s.isUnixTimeAfter(t, "-1", "minute")
                } else
                    "middle" === d.getBrowserNotificationFrequency() ? (t = e[e.length - 1].time,
                    a = s.isUnixTimeAfter(t, "-1", "minute")) : "low" === d.getBrowserNotificationFrequency() && (t = e[e.length - 1].time,
                    a = s.isUnixTimeAfter(t, "-5", "minute"));
                return a && c.debug("[ariaNgNotificationService.isReachBrowserNotificationFrequencyLimit] reach frequency limit" + (t ? ", the oldest time is " + t : "")),
                a
            }() || (t = angular.extend({
                icon: "tileicon.png"
            }, t),
            function() {
                if (d.getBrowserNotificationFrequency() && "unlimited" !== d.getBrowserNotificationFrequency()) {
                    ...
                    angular.isArray(e) || (e = []),
                    e.push({
                        time: s.getCurrentUnixTime()
                    }),
                    10 < e.length && e.splice(0, e.length - 10),
                    r.set(i.browserNotificationHistoryStorageKey, e)
                }
            }(),
        ...
        return {
            ...
            requestBrowserPermission: function(t) {
                var a;
                u && (a = function(e) {
                    e.granted || d.setBrowserNotification(!1),
                    t && t(e)
                }
                ,
                n.Notification && n.Notification.requestPermission(function(e) {
                    a && a({
                        granted: p(e),
                        permission: e
                    })
            ...
            notifyViaBrowser: function(e, t, a) {
                return a || (a = {}),
                e && (e = l.getLocalizedText(e, a.titleParams)),
                t && (t = l.getLocalizedText(t, a.contentParams)),
                n = e,
                i = t,
                (s = a) || (s = {}),
                s.body = i,
                d.getBrowserNotificationSound() || (s.silent = !0),
                void (u && d.getBrowserNotification() && g(n, s));
                var n, i, s
            },
            ...
            notifyInPage: function(e, t, a) {
                ...
                (s = a) || (s = {}),
                (i = t) ? (s.title = n,
                s.message = i) : s.message = n,
                s.type && o[s.type] || (s.type = "primary"),
                s.positionY || (s.positionY = "top"),
                o[s.type](s);
                var n, i, s
            },
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgLocalizationService", ["$translate", "amMoment", function(a, t) {
        return {
...
function() {
    ...
    angular.module("ariaNg").factory("ariaNgLogService", ["$log", "ariaNgConstants", function(a, o) {
        var i = {
          ...
          , n = function(e, t, a) {
            var n, i, s;
            l && (c.length >= o.cachedDebugLogsLimit && c.shift(),
            c.push((n = e,
            i = t,
            s = a,
            {
        ...
        return {
            ...
            debug: function(e, t) {
                l && (t ? a.debug("[AriaNg Debug]" + e, t) : a.debug("[AriaNg Debug]" + e),
                n(e, "DEBUG", t))
            },
            info: function(e, t) {
    ...
    angular.module("ariaNg").factory("ariaNgSettingService", ["$window", "$location", "$filter", "ariaNgConstants", "ariaNgDefaultOptions", "ariaNgLanguages", "ariaNgCommonService", "ariaNgLogService", "ariaNgStorageService", function(n, t, e, i, o, s, r, l, c) {
        var a = {
          ...
          , y = function() {
            ...
            h(e) || v())),
            !t) {
                if ((t = angular.extend({}, o)).language = v(),
                t.rpcHost || S(t),
          ...
          , k = function(e) {
            var t = y();
            return angular.isUndefined(t[e]) && angular.isDefined(o[e]) && (t[e] = o[e],
            b(t)),
            t[e]
        }
          , w = function(e, t) {
          ...
          , S = function(e) {
            ...
            m() && (e.protocol = i.defaultSecureProtocol)
        }
          , x = function(e) {
            return {
                rpcAlias: e.rpcAlias,
                ...
                rpcRequestHeaders: e.rpcRequestHeaders,
                secret: e.secret
            }
        }
          , T = function() {
        ...
        return {
            ...
            getBrowserNotification: function() {
                return k("browserNotification")
            },
            setBrowserNotification: function(e) {
                w("browserNotification", e)
            },
            getBrowserNotificationSound: function() {
                return k("browserNotificationSound")
            },
            setBrowserNotificationSound: function(e) {
                w("browserNotificationSound", e)
            },
            getBrowserNotificationFrequency: function() {
                return k("browserNotificationFrequency")
            },
            setBrowserNotificationFrequency: function(e) {
                w("browserNotificationFrequency", e)
            },
            getWebSocketReconnectInterval: function() {
                return k("webSocketReconnectInterval")
            },
            setWebSocketReconnectInterval: function(e) {
                w("webSocketReconnectInterval", e)
            },
            getTitleRefreshInterval: function() {
                return k("titleRefreshInterval")
            },
            setTitleRefreshInterval: function(e) {
                w("titleRefreshInterval", Math.max(parseInt(e), 0))
            },
            getGlobalStatRefreshInterval: function() {
                return k("globalStatRefreshInterval")
            },
            setGlobalStatRefreshInterval: function(e) {
                w("globalStatRefreshInterval", Math.max(parseInt(e), 0))
            },
            getDownloadTaskRefreshInterval: function() {
                return k("downloadTaskRefreshInterval")
            },
            setDownloadTaskRefreshInterval: function(e) {
                w("downloadTaskRefreshInterval", Math.max(parseInt(e), 0))
            },
            getKeyboardShortcuts: function() {
                return k("keyboardShortcuts")
            },
            setKeyboardShortcuts: function(e) {
                w("keyboardShortcuts", e)
            },
            getSwipeGesture: function() {
                return k("swipeGesture")
            },
            setSwipeGesture: function(e) {
                w("swipeGesture", e)
            },
            getDragAndDropTasks: function() {
                return k("dragAndDropTasks")
            },
            setDragAndDropTasks: function(e) {
                w("dragAndDropTasks", e)
            },
            getRPCListDisplayOrder: function() {
                return k("rpcListDisplayOrder")
            },
            setRPCListDisplayOrder: function(e) {
                w("rpcListDisplayOrder", e)
            },
            getAfterCreatingNewTask: function() {
                return k("afterCreatingNewTask")
            },
            setAfterCreatingNewTask: function(e) {
                w("afterCreatingNewTask", e)
            },
            getRemoveOldTaskAfterRetrying: function() {
                return k("removeOldTaskAfterRetrying")
            },
            setRemoveOldTaskAfterRetrying: function(e) {
                w("removeOldTaskAfterRetrying", e)
            },
            getConfirmTaskRemoval: function() {
                return k("confirmTaskRemoval")
            },
            setConfirmTaskRemoval: function(e) {
                w("confirmTaskRemoval", e)
            },
            getIncludePrefixWhenCopyingFromTaskDetails: function() {
                return k("includePrefixWhenCopyingFromTaskDetails")
            },
            setIncludePrefixWhenCopyingFromTaskDetails: function(e) {
                w("includePrefixWhenCopyingFromTaskDetails", e)
            },
            getShowPiecesInfoInTaskDetailPage: function() {
                return k("showPiecesInfoInTaskDetailPage")
            },
            setShowPiecesInfoInTaskDetailPage: function(e) {
                w("showPiecesInfoInTaskDetailPage", e)
            },
            getAfterRetryingTask: function() {
                return k("afterRetryingTask")
            },
            setAfterRetryingTask: function(e) {
                w("afterRetryingTask", e)
            },
            ...
            setDefaultRpcSetting: function(e, t) {
                ...
                for (var i = null, s = 0; s < a.extendRpcServers.length; s++)
                    if (a.extendRpcServers[s].rpcId === e.rpcId) {
                        i = x(a.extendRpcServers[s]),
                        a.extendRpcServers.splice(s, 1);
                        break
                    }
                return t.forceSet && (i = x(e)).secret && (i.secret = r.base64Encode(i.secret)),
            ...
            isRpcSettingEqualsDefault: function(e) {
                ...
                return t.rpcHost === e.rpcHost && (t.rpcPort === e.rpcPort && (t.rpcInterface === e.rpcInterface && (t.protocol === e.protocol && (t.httpMethod === e.httpMethod && (t.rpcRequestHeaders === e.rpcRequestHeaders && t.secret === e.secret)))))
            },
            getDisplayOrder: function() {
                var e = k("displayOrder");
            ...
            getFileListDisplayOrder: function() {
                var e = k("fileListDisplayOrder");
                return e || (e = "default:asc"),
                e
            },
            setFileListDisplayOrder: function(e) {
                w("fileListDisplayOrder", e)
            },
            getPeerListDisplayOrder: function() {
                var e = k("peerListDisplayOrder");
                return e || (e = "default:asc"),
                e
            },
            setPeerListDisplayOrder: function(e) {
                w("peerListDisplayOrder", e)
            },
            ...
            for (var t = {
                ...
                tooltip: {
                    ...
                    formatter: function(e) {
                        if ("" === e[0].name)
                            return "<div>" + r.getLocalizedText("No Data") + "</div>";
...
function() {
    ...
    angular.module("ariaNg").factory("ariaNgTitleService", ["$filter", "ariaNgConstants", "ariaNgLocalizationService", "ariaNgSettingService", function(d, f, m, h) {
        var u = function(e) {
          ...
          , v = function(e, t, a) {
            var n, i, s, o = new RegExp("\\$\\{" + t + "(:[a-zA-Z0-9]+(=[a-zA-Z0-9]+)?)*\\}","g"), r = e.match(o);
            if (r && 0 < r.length)
        ...
        return {
            getFinalTitle: function(e) {
                var t, a, n, i, s, o, r, l, c, d, u, p, g = h.getTitle();
                return g ? (e = angular.extend({
                    downloadingCount: 0,
                    waitingCount: 0,
                    stoppedCount: 0,
                    downloadSpeed: 0,
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgVersionService", ["ariaNgBuildConfiguration", function(e) {
        return {
            getBuildVersion: function() {
                return e.buildVersion
            },
            getBuildCommit: function() {
                return e.buildCommit
            }
        }
    }
    ])
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2HttpRpcService", ["$http", "ariaNgConstants", "ariaNgCommonService", "ariaNgSettingService", "ariaNgLogService", function(l, c, d, e, u) {
        var p = e.getCurrentRpcUrl()
          , g = e.getCurrentRpcHttpMethod()
          , f = e.getCurrentRpcRequestHeaders();
        return {
            request: function(a) {
                if (a) {
                    var e = {
                    ...
                    if ("POST" === e.method ? e.data = a.requestBody : "GET" === e.method && (e.url = function(e, t) {
                        if (!e || e.length < 1)
                            return e;
                        var a = "";
                        for (var n in t)
                    ...
                    return u.debug("[aria2HttpRpcService.request] " + (a && a.requestBody && a.requestBody.method ? a.requestBody.method + " " : "") + "request start", e),
                    l(e).then(function(e) {
                        var t = e.data;
                        u.debug("[aria2HttpRpcService.request] " + (a && a.requestBody && a.requestBody.method ? a.requestBody.method + " " : "") + "response success", e),
                        ...
                        var t = e.data;
                        u.debug("[aria2HttpRpcService.request] " + (a && a.requestBody && a.requestBody.method ? a.requestBody.method + " " : "") + "response error", e),
                        t || (t = {
                            id: "-1",
                            error: {
...
function() {
    ...
    angular.module("ariaNg").factory("aria2WebSocketRpcService", ["$q", "$websocket", "$timeout", "ariaNgConstants", "ariaNgSettingService", "ariaNgLogService", function(s, e, t, a, n, o) {
        var i = n.getCurrentRpcUrl()
          ...
          , u = function(a) {
            if (null === r)
                try {
                    (r = e(i, {
                        maxTimeout: 1,
                        reconnectInterval: n.getWebSocketReconnectInterval()
                            ...
                            t && (t.id ? function(e) {
                                ...
                                if (t) {
                                    ...
                                    if (a) {
                                        ...
                                        e.result && n.successCallback && (o.debug("[aria2WebSocketRpcService.processMethodCallback] " + (n && n.requestBody && n.requestBody.method ? n.requestBody.method + " " : "") + "response success", e),
                                        n.successCallback(n.id, e.result)),
                                        e.error && n.errorCallback && (o.debug("[aria2WebSocketRpcService.processMethodCallback] " + (n && n.requestBody && n.requestBody.method ? n.requestBody.method + " " : "") + "response error", e),
                                ...
                                if (t) {
                                    ...
                                    if (a) {
                                        ...
                                        if (n) {
                                            ...
                                            i.errorCallback && (o.debug("[aria2WebSocketRpcService.processRequestFailed] " + (i && i.requestBody && i.requestBody.method ? i.requestBody.method + " " : "") + "request failed"),
                                            i.errorCallback(i.id, {
                                                message: "Cannot connect to aria2!"
                                            })),
                                            delete c[a]
                                        }
                    ...
                    r.onOpen(function(e) {
                        ...
                        a && a.connectionSuccessCallback && a.connectionSuccessCallback({
                            rpcUrl: i
                        })
                    }),
                    r.onClose(function(e) {
                        ...
                        t && g(a),
                        t && a && a.connectionWaitingToReconnectCallback ? a.connectionWaitingToReconnectCallback({
                            rpcUrl: i
                        }) : a && a.connectionFailedCallback && a.connectionFailedCallback({
                            rpcUrl: i
                        })
                    })
                } catch (e) {
            ...
            if (e && r) {
                for (var t in c)
                    if (c.hasOwnProperty(t)) {
                        ...
                        o.debug("[aria2WebSocketRpcService.reconnect] reject old request", a.context),
                        a.context.errorCallback(a.context.id, {
                            message: "Cannot connect to aria2!"
                        })),
                        delete c[t]
                    }
                e.connectionReconnectingCallback && e.connectionReconnectingCallback({
                    rpcUrl: i
                }),
                r.reconnect()
            }
          ...
          , g = function(e) {
            l ? o.warn("[aria2WebSocketRpcService.planToReconnect] another reconnection is pending") : (l = t(function() {
                return null == r ? o.warn("[aria2WebSocketRpcService.planToReconnect] websocket is null") : 0 === r.readyState || 1 === r.readyState ? o.warn("[aria2WebSocketRpcService.planToReconnect] websocket current state is already " + r.readyState) : p(e),
                void (l = null)
            }, n.getWebSocketReconnectInterval()),
            o.debug("[aria2WebSocketRpcService.planToReconnect] next reconnection is pending in " + n.getWebSocketReconnectInterval() + "ms"))
        };
        return {
            request: function(e) {
                if (e) {
                    var t = u({
                        ...
                        connectionReconnectingCallback: e.connectionReconnectingCallback,
                        connectionWaitingToReconnectCallback: e.connectionWaitingToReconnectCallback
                    })
                      , a = e.uniqueId
                    ...
                    var i = s.defer();
                    return t.instance ? (c[a] = {
                        context: e,
                        deferred: i
                    },
                    t.instance.send(n)) : (i.reject({
                        success: !1,
                        context: e
                    }),
    ...
    angular.module("ariaNg").factory("aria2RpcService", ["$location", "$q", "aria2RpcConstants", "aria2RpcErrors", "aria2AllOptions", "ariaNgCommonService", "ariaNgLogService", "ariaNgSettingService", "aria2HttpRpcService", "aria2WebSocketRpcService", function(r, l, c, d, i, u, p, g, e, t) {
        var s = g.isCurrentRpcUseWebSocket() ? t : e
          ...
          , O = function() {
            var e = arguments[0]
              ...
              , n = {
                ...
                connectionReconnectingCallback: function() {
                    A(w)
                },
                connectionWaitingToReconnectCallback: function() {
                    A(S)
                }
            };
            if (m && !t && a.push(c.rpcTokenPrefix + m),
            1 < arguments.length) {
                var o = arguments[1];
                n.successCallback = function(e, t) {
                    ...
                    !f) {
                        f = !0;
                        var a = {
                            rpcName: g.getCurrentRpcDisplayName()
                        };
                        A(h, a)
                    }
                }
                ...
                n.errorCallback = function(e, t) {
                    var a, n = !1, i = r.path();
                    o.silent || i !== s || (n = !(!(a = t) || !a.message || (p.error("[aria2RpcService.processError] " + a.message, a),
                    d[a.message] && d[a.message].tipTextKey ? u.showError(d[a.message].tipTextKey) : u.showError(a.message),
                    0))),
            ...
            if (2 < arguments.length)
                for (var i = 2; i < arguments.length; i++)
                    null !== arguments[i] && angular.isDefined(arguments[i]) && a.push(arguments[i]);
          ...
          , I = function(e, t) {
            ...
            for (var n in a)
                a.hasOwnProperty(n) && L(a, n) && (a[n] = F(a[n], i[n]));
        ...
        D("onDownloadPause", n),
        D("onDownloadStop", o),
        D("onDownloadComplete", x),
        D("onDownloadError", T),
        D("onBtDownloadComplete", C),
        {
            ...
            canReconnect: function() {
                return g.isCurrentRpcUseWebSocket()
            },
            reconnect: function(e) {
                p.info("[aria2RpcService.reconnect] reconnect now"),
                s.reconnect(O("", e))
            },
            addUri: function(e, t) {
                var a = e.task ? e.task.urls : null
                  , n = I(e.task ? e.task.options : {}, e);
                return R(O("addUri", e, a, n), !!t)
            },
            addUriMulti: function(e) {
                ...
                return N(this.addUri, t, e.callback)
            },
            addTorrent: function(e, t) {
                var a = e.task ? e.task.content : null
                  , n = I(e.task ? e.task.options : {}, e);
                return R(O("addTorrent", e, a, [], n), !!t)
            },
            addMetalink: function(e, t) {
                var a = e.task ? e.task.content : null
                  , n = I(e.task ? e.task.options : {}, e);
                return R(O("addMetalink", e, a, n), !!t)
            },
            remove: function(e, t) {
                return R(O("remove", e, e.gid), !!t)
            },
            forceRemove: function(e, t) {
                return R(O("forceRemove", e, e.gid), !!t)
            },
            forceRemoveMulti: function(e) {
                ...
                return N(this.forceRemove, t, e.callback)
            },
            pause: function(e, t) {
                return R(O("pause", e, e.gid), !!t)
            },
            pauseAll: function(e, t) {
                return R(O("pauseAll", e), !!t)
            },
            forcePause: function(e, t) {
                return R(O("forcePause", e, e.gid), !!t)
            },
            forcePauseMulti: function(e) {
                ...
                return N(this.forcePause, t, e.callback)
            },
            forcePauseAll: function(e, t) {
                return R(O("forcePauseAll", e), !!t)
            },
            unpause: function(e, t) {
                return R(O("unpause", e, e.gid), !!t)
            },
            unpauseMulti: function(e) {
                ...
                return N(this.unpause, t, e.callback)
            },
            unpauseAll: function(e, t) {
                return R(O("unpauseAll", e), !!t)
            },
            tellStatus: function(e, t) {
                return R(O("tellStatus", e, e.gid), !!t)
            },
            getUris: function(e, t) {
                return R(O("getUris", e, e.gid), !!t)
            },
            getFiles: function(e, t) {
                return R(O("getFiles", e, e.gid), !!t)
            },
            getPeers: function(e, t) {
                return R(O("getPeers", e, e.gid), !!t)
            },
            getServers: function(e, t) {
                return R(O("getServers", e, e.gid), !!t)
            },
            tellActive: function(e, t) {
                return R(O("tellActive", e, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            tellWaiting: function(e, t) {
                return R(O("tellWaiting", e, angular.isDefined(e.offset) ? e.offset : 0, angular.isDefined(e.num) ? e.num : 1e3, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            tellStopped: function(e, t) {
                return R(O("tellStopped", e, angular.isDefined(e.offset) ? e.offset : -1, angular.isDefined(e.num) ? e.num : 1e3, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t)
            },
            changePosition: function(e, t) {
                return R(O("changePosition", e, e.gid, e.pos, e.how), !!t)
            },
            changeUri: function(e, t) {
                return R(O("changeUri", e, e.gid, e.fileIndex, e.delUris, e.addUris), !!t)
            },
            getOption: function(e, t) {
                return R(O("getOption", e, e.gid), !!t)
            },
            changeOption: function(e, t) {
                var a = I(e.options, e);
                return R(O("changeOption", e, e.gid, a), !!t)
            },
            getGlobalOption: function(e, t) {
                return R(O("getGlobalOption", e), !!t)
            },
            changeGlobalOption: function(e, t) {
                var a = I(e.options, e);
                return R(O("changeGlobalOption", e, a), !!t)
            },
            getGlobalStat: function(e, t) {
                return R(O("getGlobalStat", e), !!t)
            },
            purgeDownloadResult: function(e, t) {
                return R(O("purgeDownloadResult", e), !!t)
            },
            removeDownloadResult: function(e, t) {
                return R(O("removeDownloadResult", e, e.gid), !!t)
            },
            removeDownloadResultMulti: function(e) {
                ...
                return N(this.removeDownloadResult, t, e.callback)
            },
            getVersion: function(e, t) {
                return R(O("getVersion", e), !!t)
            },
            getSessionInfo: function(e, t) {
                return R(O("getSessionInfo", e), !!t)
            },
            shutdown: function(e, t) {
                return R(O("shutdown", e), !!t)
            },
            forceShutdown: function(e, t) {
                return R(O("forceShutdown", e), !!t)
            },
            saveSession: function(e, t) {
                return R(O("saveSession", e), !!t)
            },
            multicall: function(e, t) {
                return R(O("system.multicall", e, e.methods), !!t)
            },
            listMethods: function(e, t) {
                return R(O("system.listMethods", e), !!t)
            },
            listNotifications: function(e, t) {
                return R(O("system.listNotifications", e), !!t)
            },
            ...
            onConnectionReconnecting: function(e) {
                w.push(e.callback)
            },
            onConnectionWaitingToReconnect: function(e) {
                S.push(e.callback)
            },
    ...
    angular.module("ariaNg").factory("aria2TaskService", ["$q", "bittorrentPeeridService", "ariaNgConstants", "aria2Errors", "aria2RpcService", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", function(u, m, l, y, p, k, w, S, g) {
        var x = function(e) {
          ...
          , r = function(e, t) {
            ...
            var a, n, i = R(e.bitfield, e.numPieces);
            ...
            o || (o = w.getLocalizedText("Unknown"),
            r = !1),
            {
                name: o,
                success: r
          ...
          , d = function(e, t, a) {
            if (!e)
                ...
                e;
            for (var n = R(t.bitfield, t.numPieces), i = k.countArray(n, !0), s = t.completePercent, o = 0; o < e.length; o++) {
                var r = e[o]
                  , l = parseInt(r.uploadSpeed)
                  , c = parseInt(r.downloadSpeed)
                  , d = R(r.bitfield, t.numPieces)
                  , u = k.countArray(d, !0);
                if (r.name = r.ip + ":" + r.port,
        ...
        return {
            ...
            removeTasks: function(e, t, a) {
                ...
                var o = []
                  ...
                  , l = !1
                  , c = [];
                return 0 < n.length && o.push(p.forceRemoveMulti({
                    gids: n,
                    silent: !!a,
                    callback: function(e) {
                ...
                0 < i.length && o.push(p.removeDownloadResultMulti({
                    gids: i,
                    silent: !!a,
                    callback: function(e) {
                        k.pushArrayTo(c, e.results),
            ...
            onConnectionReconnecting: function(e) {
                e ? p.onConnectionReconnecting({
                    callback: e
                }) : S.warn("[aria2TaskService.onConnectionReconnecting] callback is null")
            },
            onConnectionWaitingToReconnect: function(e) {
                e ? p.onConnectionWaitingToReconnect({
                    callback: e
                }) : S.warn("[aria2TaskService.onConnectionWaitingToReconnect] callback is null")
            },
            onFirstSuccess: function(e) {
                e ? p.onFirstSuccess({
                    callback: e
            ...
            getCombinedPieces: function(e, t) {
                return function(e, t) {
                    for (var a = R(e, t), n = [], i = 0; i < a.length; i++) {
                        var s = a[i];
            ...
            estimateHealthPercentFromPeers: function(e, t) {
                ...
                for (s = 0; s < t.length; s++) {
                    for (var o = t[s], r = R(o.bitfield, e.numPieces), l = 0, c = 0; c < r.length; c++) {
                        var d = r[c] ? 1 : 0;
                        a[c] += d,
                        l += d
                    }
                    n < l ? (n = l,
                    i = o.completePercent) : l === n && o.completePercent > i && (i = o.completePercent)
                }
                var u = 0;
                if (0 < a.length)
                    for (; ; ) {
        ...
        return {
            ...
            getAvailableTaskOptionKeys: function(e, t) {
                for (var a = r.taskOptions, n = [], i = 0; i < a.length; i++) {
                    ...
                    s.canShow && s.canShow.indexOf(e) < 0 || ("http" === s.category && t || ("bittorrent" !== s.category || t) && (s.canUpdate && s.canUpdate.indexOf(e) < 0 && (o.readonly = !0),
                    n.push(o)))
                }
                return n
            },
            ...
            getSettingHistory: function(e) {
                if (!this.isOptionKeyValid(e))
                    return [];
                for (var t = c(e), a = l.get(t) || [], n = [], i = 0; i < Math.min(a.length, o.historyMaxStoreCount); i++)
                    n.push(a[i]);
                return n
            },
            addSettingHistory: function(e, t) {
                ...
                var a = c(e)
                  ...
                  , i = [];
                i.push(t);
                for (var s = 0; s < Math.min(n.length, o.historyMaxStoreCount - 1); s++)
                    n[s] !== t && i.push(n[s]);
                return l.set(a, i),
                i
            },
            clearSettingsHistorys: function() {
                for (var e = l.keys(o.settingHistoryKeyPrefix + "."), t = 0; t < e.length; t++)
                    l.remove(e[t])
            },
            getGlobalOption: function(e, t) {
