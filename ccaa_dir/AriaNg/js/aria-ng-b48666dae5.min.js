...
! function() {
    "use strict";
    var e, t, a;
    if (e = navigator.appName, t = navigator.appVersion.split(";"), a = t && 1 < t.length ? t[1].replace(/[ ]/g, "") : "", "Microsoft Internet Explorer" === e && ("MSIE6.0" === a || "MSIE7.0" === a || "MSIE8.0" === a || "MSIE9.0" === a)) {
        var n = document.createElement("div");
        n.className = "alert alert-danger", n.innerHTML = "Sorry, AriaNg cannot support this browser, please upgrade your browser!", document.getElementById("content-wrapper").appendChild(n)
    }
}(),
function() {
    "use strict";
    ...
    $(window, ".wrapper").resize(function() { e(), setInterval(function() { e() }, 1) }), e()
}(),
function() {
    "use strict";
...
function() {
    ...
    angular.module("ariaNg").run(["$window", "$rootScope", "$location", "$document", "$timeout", "ariaNgCommonService", "ariaNgKeyboardService", "ariaNgNotificationService", "ariaNgLogService", "ariaNgSettingService", "aria2TaskService", function(a, n, s, o, e, t, i, r, l, c, d) {
        ...
        (n.currentTheme = "light", n.searchContext = { text: "", setSearchBoxFocused: function() { angular.element("#search-box").focus() } }, n.taskContext = {
            ...
            isAllSelected: function() { for (var e = !0, t = 0; t < this.list.length; t++) { var a = this.list[t]; if (n.filterTask(a) && !this.selected[a.gid]) { e = !1; break } } return e },
            hasRetryableTask: function() { for (var e = 0; e < this.list.length; e++) { var t = this.list[e]; if (n.filterTask(t) && n.isTaskRetryable(t)) return !0 } return !1 },
            hasCompletedTask: function() { for (var e = 0; e < this.list.length; e++) { var t = this.list[e]; if (n.filterTask(t) && "complete" === t.status) return !0 } return !1 },
            selectAll: function() {
        ...
        }, n.filterTask = function(e) { return !(!e || !angular.isString(e.taskName)) && (!n.searchContext || !n.searchContext.text || 0 <= e.taskName.toLowerCase().indexOf(n.searchContext.text.toLowerCase())) }, n.isTaskRetryable = function(e) { return e && "error" === e.status && e.errorDescription && !e.bittorrent }, n.keydownActions = { find: function(e) { return e.preventDefault && e.preventDefault(), n.searchContext.setSearchBoxFocused(), !1 } }, n.swipeActions = { leftSwipe: function() { c.getSwipeGesture() && (angular.element("body").hasClass("sidebar-open") ? h() : (!this.extendLeftSwipe || angular.isFunction(this.extendLeftSwipe) && !this.extendLeftSwipe()) && h()) }, rightSwipe: function() { c.getSwipeGesture() && (!this.extendRightSwipe || angular.isFunction(this.extendRightSwipe) && !this.extendRightSwipe()) && angular.element("body").removeClass("sidebar-collapse").addClass("sidebar-open") } }, n.refreshPage = function() { a.location.reload() }, n.setAutoRefreshAfterPageLoad = function() { u = !0 }, n.setTheme = function(e) { "system" === e ? m() : "dark" === e ? f() : g() }, a.addEventListener("keydown", function(e) { if (c.getKeyboardShortcuts()) { var t = angular.element('input[type="text"],textarea').is(":focus"); if (i.isCtrlAPressed(e) && !t) { if (angular.isFunction(n.keydownActions.selectAll)) return n.keydownActions.selectAll(e) } else if (i.isCtrlFPressed(e)) { if (angular.isFunction(n.keydownActions.find)) return n.keydownActions.find(e) } else if (i.isDeletePressed(e) && !t && angular.isFunction(n.keydownActions.delete)) return n.keydownActions.delete(e) } }, !0), c.onFirstAccess(function() { r.notifyInPage("", "Tap to configure and get started with AriaNg.", { delay: !1, onClose: function() { s.path("/settings/ariang") } }) }), d.onFirstSuccess(function(e) { r.notifyInPage("", "is connected", { type: "success", contentPrefix: e.rpcName + " " }) }), d.onConnectionSuccess(function() { e(function() { "Connected" !== n.taskContext.rpcStatus && (n.taskContext.rpcStatus = "Connected") }) }), d.onConnectionFailed(function() { e(function() { "Disconnected" !== n.taskContext.rpcStatus && (n.taskContext.rpcStatus = "Disconnected") }) }), d.onConnectionReconnecting(function() { e(function() { "Reconnecting" !== n.taskContext.rpcStatus && (n.taskContext.rpcStatus = "Reconnecting") }) }), d.onConnectionWaitingToReconnect(function() { e(function() { "Waiting to reconnect" !== n.taskContext.rpcStatus && (n.taskContext.rpcStatus = "Waiting to reconnect") }) }), d.onTaskCompleted(function(e) { r.notifyTaskComplete(e.task) }), d.onBtTaskCompleted(function(e) { r.notifyBtTaskComplete(e.task) }), d.onTaskErrorOccur(function(e) { r.notifyTaskError(e.task) }), n.$on("$locationChangeStart", function(e) { t.closeAllDialogs(), n.loadPromise = null, delete n.keydownActions.selectAll, delete n.keydownActions.delete, delete n.swipeActions.extendLeftSwipe, delete n.swipeActions.extendRightSwipe, angular.isArray(n.taskContext.list) && 0 < n.taskContext.list.length && (n.taskContext.list.length = 0), angular.isObject(n.taskContext.selected) && (n.taskContext.selected = {}), n.taskContext.enableSelectAll = !1 }), n.$on("$routeChangeStart", function(e, t, a) {
            var n, i = s.path();
            n = i, angular.element("section.sidebar > ul li").removeClass("active"), angular.element("section.sidebar > ul > li[data-href-match]").each(function(e, t) {
                var a = angular.element(t).attr("data-href-match");
                p(a, n) && angular.element(t).addClass("active")
            }), angular.element("section.sidebar > ul > li.treeview > ul.treeview-menu > li[data-href-match]").each(function(e, t) {
                var a = angular.element(t).attr("data-href-match");
                p(a, n) && angular.element(t).addClass("active").parent().parent().addClass("active")
            }), o.unbind("keypress")
        }), c.isBrowserSupportDarkMode()) && a.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", function(e) { l.info("[root] system switches to " + (e.matches ? "dark" : "light") + " theme"), "system" === c.getTheme() && (e.matches ? f() : g()) });
        n.$on("$locationChangeSuccess", function(e, t) { u && a.location.reload() }), "system" === c.getTheme() ? m() : "dark" === c.getTheme() ? f() : g(),
            function() { var e = c.getBrowserFeatures(); if (e.localStroage || l.warn("[root.initCheck] LocalStorage is not supported!"), e.cookies || l.warn("[root.initCheck] Cookies is not supported!"), !c.isBrowserSupportStorage()) throw angular.element("body").prepend('<div class="disable-overlay"></div>'), angular.element(".main-sidebar").addClass("blur"), angular.element(".navbar").addClass("blur"), angular.element(".content-body").addClass("blur"), r.notifyInPage("", "You cannot use AriaNg because this browser does not meet the minimum requirements for data storage.", { type: "error", delay: !1 }), new Error("You cannot use AriaNg because this browser does not meet the minimum requirements for data storage.") }(), angular.element("section.sidebar > ul > li[data-href-match] > a").click(function() { angular.element("section.sidebar > ul li").removeClass("active"), angular.element(this).parent().addClass("active") }), angular.element("section.sidebar > ul > li.treeview > ul.treeview-menu > li[data-href-match] > a").click(function() { angular.element("section.sidebar > ul li").removeClass("active"), angular.element(this).parent().addClass("active").parent().parent().addClass("active") })
    }])
}(),
function() {
    "use strict";
...
function() {
    "use strict";
    angular.module("ariaNg").constant("ariaNgBuildConfiguration", { buildVersion: "v1.3.7", buildCommit: "1d253b4" })
}(),
function() {
    "use strict";
...
function() {
    "use strict";
    angular.module("ariaNg").constant("ariaNgLanguages", { en: { name: "English", displayName: "English" }, zh_Hans: { name: "Simplified Chinese", displayName: "简体中文", aliases: ["zh_CHS", "zh_CN", "zh_SG"] }, zh_Hant: { name: "Traditional Chinese", displayName: "繁體中文", aliases: ["zh_CHT", "zh_TW", "zh_HK", "zh_MO"] } })
}(),
function() {
    "use strict";
...
function() {
    ...
    angular.module("ariaNg").controller("MainController", ["$rootScope", "$scope", "$route", "$window", "$location", "$document", "$interval", "clipboard", "aria2RpcErrors", "ariaNgCommonService", "ariaNgVersionService", "ariaNgNotificationService", "ariaNgSettingService", "ariaNgMonitorService", "ariaNgTitleService", "aria2TaskService", "aria2SettingService", function(i, s, o, t, r, a, n, l, c, d, e, u, p, g, f, m, h) {
        var v = null,
            y = null,
            b = function() { var e = r.path().substring(1); return "downloading" === e || "waiting" === e || "stopped" === e ? e : "" },
            k = function() {
                var e = f.getFinalTitleByGlobalStat({ globalStat: s.globalStat, currentRpcProfile: S() });
                a[0].title = e
            },
            w = function(e, t) { return h.getGlobalStat(function(e) { e.success || e.data.message !== c.Unauthorized.message ? (e.success && (s.globalStat = e.data, g.recordGlobalStat(e.data)), t && t(e)) : n.cancel(y) }, e) },
            S = function() { if (!s.rpcSettings || s.rpcSettings.length < 1) return null; for (var e = 0; e < s.rpcSettings.length; e++) { var t = s.rpcSettings[e]; if (t.isDefault) return t } return null };
        p.getBrowserNotification() && u.requestBrowserPermission(), s.ariaNgVersion = e.getBuildVersion(), s.globalStatusContext = { isEnabled: 0 < p.getGlobalStatRefreshInterval(), data: g.getGlobalStatsData() }, s.enableDebugMode = function() { return p.isEnableDebugMode() }, s.quickSettingContext = null, s.rpcSettings = p.getAllRpcSettings(), s.currentRpcProfile = S(), s.isCurrentRpcUseWebSocket = p.isCurrentRpcUseWebSocket(), s.isTaskSelected = function() { return 0 < i.taskContext.getSelectedTaskIds().length }, s.isSelectedTasksAllHaveUrl = function() {
            var e = i.taskContext.getSelectedTasks();
            if (e.length < 1) return !1;
            for (var t = 0; t < e.length; t++)
                if (!e[t].singleUrl) return !1;
            return !0
            ...
            if (a && !(a.length < 1)) {
                var e = null;
                if ("start" === t) e = m.startTasks;
                else {
                    if ("pause" !== t) return;
                    e = m.pauseTasks
                }
                i.loadPromise = e(a, function(e) { e.hasError && 1 < a.length && d.showError("Failed to change some tasks state."), e.hasSuccess && (w(!0), e.hasError || "start" !== t ? e.hasError || "pause" !== t || ("/downloading" === r.path() ? r.path("/waiting") : o.reload()) : "/waiting" === r.path() ? r.path("/downloading") : o.reload()) }, 1 < a.length)
            }
        }, s.retryTask = function(e) {
            d.confirm("Confirm Retry", "Are you sure you want to retry the selected task? AriaNg will create same task after clicking OK.", "info", function() {
                i.loadPromise = m.retryTask(e.gid, function(e) {
                    if (e.success) {
                        w(!0);
                        var t = p.getAfterRetryingTask();
                        e.success && e.data && ("task-list-downloading" === t ? "/downloading" !== r.path() ? r.path("/downloading") : o.reload() : "task-detail" === t ? r.path("/task/detail/" + e.data) : o.reload())
                    } else d.showError("Failed to retry this task.")
                }, !1)
            })
        }, s.hasRetryableTask = function() { return i.taskContext.hasRetryableTask() }, s.hasCompletedTask = function() { return i.taskContext.hasCompletedTask() }, s.isSelectedTaskRetryable = function() {
            var e = i.taskContext.getSelectedTasks();
            if (e.length < 1) return !1;
            for (var t = 0; t < e.length; t++)
            ...
            if (e && !(e.length < 1)) {
                ...
                d.confirm("Confirm Retry", "Are you sure you want to retry the selected task? AriaNg will create same task after clicking OK.", "info", function() {
                    i.loadPromise = m.retryTasks(t, function(t) {
                        w(!0), d.showInfo("Operation Result", "{successCount} tasks have been retried and {failedCount} tasks are failed.", function() {
                            var e = p.getAfterRetryingTask();
                            t.hasSuccess && ("task-list-downloading" === e && "/downloading" !== r.path() ? r.path("/downloading") : o.reload())
                        }, { textParams: { successCount: t.successCount, failedCount: t.failedCount, skipCount: a } })
                    }, !1)
                }, !0)
            }
            ...
            if (t && !(t.length < 1)) {
                var e = function() { i.loadPromise = m.removeTasks(t, function(e) { e.hasError && 1 < t.length && d.showError("Failed to remove some task(s)."), e.hasSuccess && (w(!0), e.hasError || ("/stopped" !== r.path() ? r.path("/stopped") : o.reload())) }, 1 < t.length) };
                p.getConfirmTaskRemoval() ? d.confirm("Confirm Remove", "Are you sure you want to remove the selected task?", "warning", e) : e()
            }
        }, s.clearStoppedTasks = function() { d.confirm("Confirm Clear", "Are you sure you want to clear stopped tasks?", "warning", function() { i.loadPromise = m.clearStoppedTasks(function(e) { e.success && (w(!0), "/stopped" !== r.path() ? r.path("/stopped") : o.reload()) }) }) }, s.isAllTasksSelected = function() { return i.taskContext.isAllSelected() }, s.selectAllTasks = function() { i.taskContext.selectAll() }, s.selectAllFailedTasks = function() { i.taskContext.selectAllFailed() }, s.selectAllCompletedTasks = function() { i.taskContext.selectAllCompleted() }, s.copySelectedTasksDownloadLink = function() {
            for (var e = i.taskContext.getSelectedTasks(), t = "", a = 0; a < e.length; a++) 0 < a && (t += "\n"), t += e[a].singleUrl;
            0 < t.length && l.copyText(t)
        }, s.copySelectedTasksMagnetLink = function() {
            for (var e = i.taskContext.getSelectedTasks(), t = "", a = 0; a < e.length; a++) 0 < a && (t += "\n"), t += "magnet:?xt=urn:btih:" + e[a].infoHash;
            0 < t.length && l.copyText(t)
        }, s.changeDisplayOrder = function(e, t) {
            var a = b(),
                n = d.parseOrderType(p.getDisplayOrder(a)),
                i = d.parseOrderType(e);
            t && i.type === n.type && (i.reverse = !n.reverse), p.setDisplayOrder(i.getValue(), a)
        }, s.isSetDisplayOrder = function(e) {
            var t = b(),
                a = d.parseOrderType(p.getDisplayOrder(t)),
                n = d.parseOrderType(e);
            return a.equals(n)
        }, s.showQuickSettingDialog = function(e, t) { s.quickSettingContext = { type: e, title: t } }, s.switchRpcSetting = function(e) { e.isDefault || (p.setDefaultRpcSetting(e), 0 === r.path().indexOf("/task/detail/") ? (i.setAutoRefreshAfterPageLoad(), r.path("/downloading")) : t.location.reload()) }, 0 < p.getTitleRefreshInterval() && (v = n(function() { k() }, p.getTitleRefreshInterval())), 0 < p.getGlobalStatRefreshInterval() && (y = n(function() { w(!0) }, p.getGlobalStatRefreshInterval())), s.$on("$destroy", function() { v && n.cancel(v), y && n.cancel(y) }), w(!0, function() { k() })
    }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").controller("NewTaskController", ["$rootScope", "$scope", "$location", "$timeout", "ariaNgCommonService", "ariaNgLogService", "ariaNgKeyboardService", "ariaNgFileService", "ariaNgSettingService", "aria2TaskService", "aria2SettingService", function(g, f, m, e, i, t, a, n, h, v, s) {
        var o, r = [{ name: "links", show: !0 }, { name: "options", show: !0 }],
            l = m.search(),
            c = function() { for (var e = [], t = 0; t < r.length; t++) r[t].show && e.push(r[t].name); return e },
            y = function(e) { e && e.dir && s.addSettingHistory("dir", e.dir) },
            b = function(e) {
                var t = i.parseUrlsFromOriginInput(f.context.urls),
                    a = [];
                e || (e = angular.copy(f.context.options));
                for (var n = 0; n < t.length; n++) "" !== t[n] && "" !== t[n].trim() && a.push({ urls: [t[n].trim()], options: e });
                return a
            };
        if (f.context = { currentTab: "links", taskType: "urls", urls: "", uploadFile: null, availableOptions: (o = s.getNewTaskOptionKeys(), s.getSpecifiedOptions(o, { disableRequired: !0 })), globalOptions: null, options: {}, optionFilter: { global: !0, http: !1, bittorrent: !1 }, exportCommandApiOptions: null }, l.url) try { f.context.urls = i.base64UrlDecode(l.url) } catch (e) { t.error("[NewTaskController] base64 decode error, url=" + l.url, e) } f.changeTab = function(e) { "options" === e && f.loadDefaultOption(), f.context.currentTab = e }, g.swipeActions.extendLeftSwipe = function() {
            var e = c(),
                t = e.indexOf(f.context.currentTab);
            return t < e.length - 1 && (f.changeTab(e[t + 1]), !0)
        }, g.swipeActions.extendRightSwipe = function() {
            var e = c(),
                t = e.indexOf(f.context.currentTab);
            return 0 < t && (f.changeTab(e[t - 1]), !0)
        }, f.loadDefaultOption = function() { f.context.globalOptions || (g.loadPromise = s.getGlobalOption(function(e) { e.success && (f.context.globalOptions = e.data) })) }, f.openTorrent = function() { n.openFileContent({ scope: f, fileFilter: ".torrent", fileType: "binary" }, function(e) { f.context.uploadFile = e, f.context.taskType = "torrent", f.changeTab("options") }, function(e) { i.showError(e) }, angular.element("#file-holder")) }, f.openMetalink = function() { n.openFileContent({ scope: f, fileFilter: ".meta4,.metalink", fileType: "binary" }, function(e) { f.context.uploadFile = e, f.context.taskType = "metalink", f.changeTab("options") }, function(e) { i.showError(e) }, angular.element("#file-holder")) }, f.isNewTaskValid = function() { return !!f.context.uploadFile || f.newTaskForm.$valid }, f.startDownload = function(a) {
            var e, t, n, i, s, o, r, l, c, d, u, p = function(e) {
                if (e.hasSuccess || e.success) {
                    var t = null;
                    e.results && 0 < e.results.length ? t = e.results[0] : e && (t = e), "task-detail" === h.getAfterCreatingNewTask() && t && t.data ? m.path("/task/detail/" + t.data) : a ? m.path("/waiting") : m.path("/downloading")
                }
            };
            "urls" === f.context.taskType ? g.loadPromise = (l = a, c = p, d = angular.copy(f.context.options), u = b(d), y(d), v.newUriTasks(u, l, c)) : "torrent" === f.context.taskType ? g.loadPromise = (i = a, s = p, o = angular.copy(f.context.options), r = { content: f.context.uploadFile.base64Content, options: o }, y(r.options), v.newTorrentTask(r, i, s)) : "metalink" === f.context.taskType && (g.loadPromise = (e = a, t = p, n = { content: f.context.uploadFile.base64Content, options: angular.copy(f.context.options) }, y(n.options), v.newMetalinkTask(n, e, t)))
        }, f.showExportCommandAPIModal = function() { f.context.exportCommandApiOptions = { type: "new-task", data: b() } }, f.setOption = function(e, t, a) { "" === t && s.isOptionKeyRequired(e) ? delete f.context.options[e] : f.context.options[e] = t, a.setReady() }, f.urlTextboxKeyDown = function(e) { if (h.getKeyboardShortcuts()) return a.isCtrlEnterPressed(e) && f.newTaskForm.$valid ? (e.preventDefault && e.preventDefault(), f.startDownload(), !1) : void 0 }, f.getValidUrlsCount = function() { var e = i.parseUrlsFromOriginInput(f.context.urls); return e ? e.length : 0 }, g.loadPromise = e(function() {}, 100)
    }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").controller("DownloadListController", ["$rootScope", "$scope", "$window", "$location", "$route", "$interval", "dragulaService", "aria2RpcErrors", "ariaNgCommonService", "ariaNgSettingService", "aria2TaskService", function(o, t, e, a, n, r, i, l, c, s, d) {
        var u = a.path().substring(1),
            p = null,
            g = !1,
            f = !0,
            m = function(e) {
                if (!g) return d.getTaskList(u, f, function(e) {
                    if (!g)
                        if (e.success) {
                            ...
                            if (t) o.taskContext.list = a, f = !1;
                                ...
                                if (o.taskContext.list && 0 < o.taskContext.list.length)
                                    for (var n = 0; n < o.taskContext.list.length; n++) { delete(s = o.taskContext.list[n]).verifiedLength, delete s.verifyIntegrityPending } f = !c.extendArray(a, o.taskContext.list, "gid")
                            }
                            if (o.taskContext.list && 0 < o.taskContext.list.length && (d.processDownloadTasks(o.taskContext.list), !t)) { var i = !1; for (n = 0; n < o.taskContext.list.length; n++) { var s; if ((s = o.taskContext.list[n]).hasTaskName || s.files || s.bittorrent) { i = !0; break } } if (!i) return f = !0, void(o.taskContext.list.length = 0) } o.taskContext.enableSelectAll = o.taskContext.list && 0 < o.taskContext.list.length
                        } else e.data.message === l.Unauthorized.message && r.cancel(p)
                }, e)
            };
        t.getOrderType = function() { return s.getDisplayOrder(u) }, t.isSupportDragTask = function() { if (!s.getDragAndDropTasks()) return !1; var e = c.parseOrderType(s.getDisplayOrder(u)); return "waiting" === u && "default" === e.type }, 0 < s.getDownloadTaskRefreshInterval() && (p = r(function() { m(!0) }, s.getDownloadTaskRefreshInterval())), i.options(t, "task-list", { revertOnSpill: !0, moves: function() { return t.isSupportDragTask() } }), t.$on("task-list.drop-model", function(e, t, a) {
            var n = angular.element(t),
                i = n.attr("data-gid"),
                s = n.index();
            g = !0, d.changeTaskPosition(i, s, function() { g = !1 }, !0)
        }), t.$on("$destroy", function() { g = !0, p && r.cancel(p) }), o.keydownActions.selectAll = function(e) { return e.preventDefault && e.preventDefault(), t.$apply(function() { t.selectAllTasks() }), !1 }, o.keydownActions.delete = function(e) { return e.preventDefault && e.preventDefault(), t.$apply(function() { t.removeTasks() }), !1 }, o.loadPromise = m(!1)
    }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").controller("TaskDetailController", ["$rootScope", "$scope", "$routeParams", "$interval", "clipboard", "aria2RpcErrors", "ariaNgFileTypes", "ariaNgCommonService", "ariaNgSettingService", "ariaNgMonitorService", "aria2TaskService", "aria2SettingService", function(o, g, e, t, n, a, f, m, r, l, s, c) {
        var i = [{ name: "overview", show: !0 }, { name: "pieces", show: !0 }, { name: "filelist", show: !0 }, { name: "btpeers", show: !0 }],
            d = null,
            u = !1,
            p = null,
            h = function() { for (var e = [], t = 0; t < i.length; t++) i[t].show && e.push(i[t].name); return e },
            v = function(e, t) {
                for (var a = 0; a < i.length; a++)
                    if (i[a].name === e) { i[a].show = t; break }
            },
            y = function(e) {
                var t, a, n, i, s;
                e && (g.context.showPiecesInfo = (t = e, a = r.getShowPiecesInfoInTaskDetailPage(), !(!t || "never" === a) && ("le102400" === a ? t.numPieces <= 102400 : "le10240" === a ? t.numPieces <= 10240 : "le1024" !== a || t.numPieces <= 1024)), v("pieces", g.context.showPiecesInfo), v("btpeers", "active" === e.status && e.bittorrent), g.task && g.task.status === e.status || (g.context.availableOptions = (n = e.status, i = !!e.bittorrent, s = c.getAvailableTaskOptionKeys(n, i), c.getSpecifiedOptions(s, { disableRequired: !0 }))), g.task && (delete g.task.verifiedLength, delete g.task.verifyIntegrityPending), g.task = m.copyObjectTo(e, g.task), o.taskContext.list = [g.task], o.taskContext.selected = {}, o.taskContext.selected[g.task.gid] = !0, l.recordStat(e.gid, e))
            },
            b = function(e) { e && (m.extendArray(e, g.context.btPeers, "peerId") || (g.context.btPeers = e), g.context.healthPercent = s.estimateHealthPercentFromPeers(g.task, g.context.btPeers)) },
            k = function(e) { return e && e.bittorrent && "active" === e.status },
            w = function(a) {
                if (!u) {
                    var n = function(e) { t.cancel(d) };
                    return g.task ? s.getTaskStatusAndBtPeers(e.gid, function(e) {
                        if (!e.success) return n(e.data.message);
                        y(e.task), b(e.peers)
                    }, a, k(g.task), !0, !0) : s.getTaskStatus(e.gid, function(e) {
                        if (!e.success) return n(e.data.message);
                        var t = e.data;
                        y(t), k(t) && s.getBtTaskPeers(t, function(e) { e.success && b(e.data) }, a, !0)
                    }, a, !0)
                }
            },
            S = function(e) {
                if (g.task && g.task.files) {
                    ...
                    return u = !0, s.selectTaskFile(t, a, function(e) { u = !1, e.success && w(!1) }, e)
                }
            },
            x = function(e, t) {
                if (e) {
                    if (e.files && e.files.length)
                        for (var a = 0; a < e.files.length; a++) { e.files[a].selected = t }
            ...
            T = function(e) {
                if (e) {
                    var t = 0,
                        a = 0;
                    if (e.files && e.files.length)
                        for (var n = 0; n < e.files.length; n++) { t += e.files[n].selected ? 1 : 0 }
                    if (e.subDirs && e.subDirs.length)
        ...
        g.context = { currentTab: "overview", isEnableSpeedChart: 0 < r.getDownloadTaskRefreshInterval(), showPiecesInfo: "never" !== r.getShowPiecesInfoInTaskDetailPage(), showChooseFilesToolbar: !1, fileExtensions: [], collapsedDirs: {}, btPeers: [], healthPercent: 0, collapseTrackers: !0, statusData: l.getEmptyStatsData(e.gid), availableOptions: [], options: [] }, g.changeTab = function(e) { "settings" === e && g.loadTaskOption(g.task), g.context.currentTab = e }, o.swipeActions.extendLeftSwipe = function() {
            var e = h(),
            ...
            return t.equals(a)
        }, g.getFileListOrderType = function() { return g.task && g.task.multiDir ? null : r.getFileListDisplayOrder() }, g.showChooseFilesToolbar = function() { g.context.showChooseFilesToolbar ? g.cancelChooseFiles() : (u = !0, g.context.showChooseFilesToolbar = !0) }, g.isAnyFileSelected = function() { if (!g.task || !g.task.files) return !1; for (var e = 0; e < g.task.files.length; e++) { var t = g.task.files[e]; if (!t.isDir && t.selected) return !0 } return !1 }, g.isAllFileSelected = function() { if (!g.task || !g.task.files) return !1; for (var e = 0; e < g.task.files.length; e++) { var t = g.task.files[e]; if (!t.isDir && !t.selected) return !1 } return !0 }, g.selectFiles = function(e) {
            if (g.task && g.task.files) {
        ...
        }, g.saveChoosedFiles = function() { g.context.showChooseFilesToolbar && (o.loadPromise = S(!1), g.context.showChooseFilesToolbar = !1) }, g.cancelChooseFiles = function() { g.context.showChooseFilesToolbar && (w(!(u = !1)), g.context.showChooseFilesToolbar = !1) }, g.showCustomChooseFileModal = function() {
            if (g.task && g.task.files) {
                for (var e = g.task.files, t = {}, a = 0; a < e.length; a++) {
                    ...
                    if (!n.isDir) {
                        if ((u = m.getFileExtension(n.fileName)) && (u = u.toLowerCase()), !(p = t[u])) {
                            var i = u;
                            0 < i.length && "." === i.charAt(0) && (i = i.substring(1)), p = { extension: i, classified: !1, selected: !1, selectedCount: 0, unSelectedCount: 0 }, t[u] = p
                        }
                ...
                for (var u in t) { var p; if (t.hasOwnProperty(u))(p = t[u]).classified || d.push(p) } 0 < d.length && (s.other = { name: "Other", extensions: d }), g.context.fileExtensions = s, angular.element("#custom-choose-file-modal").modal()
            }
        ...
        }, $("#custom-choose-file-modal").on("hide.bs.modal", function(e) { g.context.fileExtensions = null }), g.setSelectedFile = function(e) { e && C(), g.context.showChooseFilesToolbar || S(!0) }, g.collapseDir = function(e, t, a) {
            var n = e.nodePath;
        ...
        }, g.setSelectedNode = function(e) { x(e, e.selected), C(), g.context.showChooseFilesToolbar || g.setSelectedFile(!1) }, g.changePeerListDisplayOrder = function(e, t) {
...
function() {
    ...
    angular.module("ariaNg").controller("Aria2SettingsController", ["$rootScope", "$scope", "$location", "ariaNgConstants", "ariaNgCommonService", "aria2SettingService", function(e, t, a, n, i, s) {
        ...
        t.context = {
            ...
            globalOptions: []
        }, t.setGlobalOption = function(e, t, a) { return s.setGlobalOption(e, t, function(e) { e.success && "OK" === e.data ? a.setSuccess() : a.setFailed(e.data.message) }, !0) }, e.loadPromise = s.getGlobalOption(function(e) { e.success && (t.context.globalOptions = e.data) })
    }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").controller("Aria2StatusController", ["$rootScope", "$scope", "$timeout", "ariaNgCommonService", "ariaNgSettingService", "aria2SettingService", function(e, t, a, n, i, s) { t.context = { host: i.getCurrentRpcUrl(), serverStatus: null, isSupportReconnect: s.canReconnect() }, t.reconnect = function() {!t.context.isSupportReconnect || "Disconnected" !== e.taskContext.rpcStatus && "Waiting to reconnect" !== e.taskContext.rpcStatus || s.reconnect() }, t.saveSession = function() { return s.saveSession(function(e) { e.success && "OK" === e.data && n.showOperationSucceeded("Session has been saved successfully.") }) }, t.shutdown = function() { n.confirm("Confirm Shutdown", "Are you sure you want to shutdown aria2?", "warning", function(e) { return s.shutdown(function(e) { e.success && "OK" === e.data && n.showOperationSucceeded("Aria2 has been shutdown successfully.") }) }, !0) }, e.$watch("taskContext.rpcStatus", function(e) { "Connected" === e ? s.getAria2Status(function(e) { e.success && (t.context.serverStatus = e.data) }) : t.context.serverStatus = null }), e.loadPromise = a(function() {}, 100) }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").directive("ngAutoFocus", ["$timeout", function(a) { return { restrict: "A", link: function(e, t) { a(function() { t[0].focus() }) } } }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").directive("ngPieceBar", ["aria2TaskService", function(u) {
        return {
            ...
            link: function(c, d) {
                ...
                c.$watch("bitField", function() { e() }), c.$watch("pieceNumber", function() { e() })
            }
        }
    }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").directive("ngPieceMap", ["aria2TaskService", function(r) {
        return {
            restrict: "E",
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngChart", ["$window", "chartTheme", function(r, l) {
        return {
            restrict: "E",
            template: "<div></div>",
            ...
            link: function(e, t, a) {
                ...
                angular.element(r).on("resize", function() { o.resize(), e.$apply() }), e.$watch("options", function(e) {
                    var t;
                    e && (t = e, o.setOption(t))
                }, !0), e.$on("$destroy", function() { o && !o.isDisposed() && o.dispose() })
            }
        }
    }]).directive("ngPopChart", ["$window", "chartTheme", function(e, o) {
        return {
            restrict: "A",
            scope: { options: "=ngData", theme: "=ngTheme" },
            link: function(n, e, i) {
                var t = { ngPopoverClass: "", ngContainer: "body", ngTrigger: "click", ngPlacement: "top" };
                angular.extend(t, i);
                var s = null,
                    a = '<div class="loading"><i class="fa fa-spinner fa-spin fa-2x"></i></div>';
                e.popover({ container: t.ngContainer, content: '<div class="chart-pop-wrapper"><div class="chart-pop ' + t.ngPopoverClass + '">' + a + "</div></div>", html: !0, placement: t.ngPlacement, template: '<div class="popover chart-popover" role="tooltip"><div class="arrow"></div><div class="popover-content"></div></div>', trigger: t.ngTrigger }).on("shown.bs.popover", function() {
                    var e = angular.element(".chart-pop"),
                        t = e.parent().height();
                    e.empty();
                    var a = parseInt(i.height) || t || 200;
                    e.css("height", a + "px"), s = echarts.init(e[0], o.get(n.theme))
                }).on("hide.bs.popover", function() { s && !s.isDisposed() && s.dispose() }).on("hidden.bs.popover", function() { angular.element(".chart-pop").empty().append(a) });
...
function() {
    ...
    angular.module("ariaNg").directive("ngExportCommandApiDialog", ["clipboard", "ariaNgCommonService", function(a, o) {
        return {
            ...
            scope: { options: "=" },
            link: function(n, t, e) {
                n.context = { trueFalseOptions: [{ name: "Enabled", value: !0 }, { name: "Disabled", value: !1 }], baseUrl: o.getFullPageUrl(), commandAPIUrl: null, pauseOnAdded: !0, isCopied: !1 };
                var i = function() { var e = n.context.baseUrl; return 0 <= e.indexOf("#") && (e = e.substring(0, e.indexOf("#"))), e },
                    s = function(e) {
                        var t = i() + "#!/new/task?url=" + o.base64UrlEncode(e.urls[0]);
                        if (n.context.pauseOnAdded && (t += "&pause=true"), e.options)
                            for (var a in e.options) e.options.hasOwnProperty(a) && (t += "&" + a + "=" + e.options[a]);
                        return t
                    };
                n.generateCommandAPIUrl = function() {
                    var e, t;
                    n.options && ("new-task" === n.options.type ? n.context.commandAPIUrl = function(e) { for (var t = "", a = 0; a < e.length; a++) 0 < a && (t += "\n"), t += s(e[a]); return t }(n.options.data) : "setting" === n.options.type && (n.context.commandAPIUrl = (e = n.options.data, t = i() + "#!/settings/rpc/set?protocol=" + e.protocol + "&host=" + e.rpcHost + "&port=" + e.rpcPort + "&interface=" + e.rpcInterface, e.secret && (t += "&secret=" + o.base64UrlEncode(e.secret)), t)), n.context.isCopied = !1)
                }, n.copyCommandAPI = function() { a.copyText(n.context.commandAPIUrl, { container: angular.element(t)[0] }), n.context.isCopied = !0 }, angular.element(t).on("hidden.bs.modal", function() { n.$apply(function() { n.options = null, n.context.commandAPIUrl = null, n.context.isCopied = !1 }) }), n.$watch("options", function(e) { e && (n.generateCommandAPIUrl(), n.context.isCopied = !1, angular.element(t).modal("show")) }, !0)
            }
        }
    }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").directive("ngIndeterminate", function() { return { restrict: "A", scope: { indeterminate: "=ngIndeterminate" }, link: function(e, t) { e.$watch("indeterminate", function() { t[0].indeterminate = "true" === e.indeterminate || !0 === e.indeterminate }) } } })
}(),
function() {
    "use strict";
    angular.module("ariaNg").directive("ngPlaceholder", function() { return { restrict: "A", scope: { placeholder: "=ngPlaceholder" }, link: function(e, t) { e.$watch("placeholder", function() { t[0].placeholder = e.placeholder }) } } })
}(),
function() {
    "use strict";
    angular.module("ariaNg").directive("ngSetting", ["$timeout", "$q", "ariaNgConstants", "ariaNgLocalizationService", "ariaNgKeyboardService", "aria2SettingService", function(p, g, f, m, h, v) {
        return {
            restrict: "E",
            templateUrl: "views/setting.html",
            require: "?ngModel",
            replace: !0,
            scope: { option: "=", ngModel: "=", defaultValue: "=?", fixedValue: "=?", onChangeValue: "&" },
            link: function(s, i, e, t) {
                var o = null,
                    r = { showPlaceholderCount: !1, deleteKeyAlwaysChangeValue: !1, lazySaveTimeout: f.lazySaveTimeout, errorTooltipPlacement: "top", errorTooltipDelay: f.errorTooltipDelay };
                angular.extend(r, e);
                var a, n = function() { s.option && s.option.showHistory && (s.history = v.getSettingHistory(s.option.key)) },
                    l = function() { angular.element(i).tooltip("destroy") },
                    c = function(t, a, n) { t && p(function() { var e = s.optionStatus.getValue(); "failed" !== e && "error" !== e || angular.element(i).tooltip({ animation: !1, title: m.getLocalizedText(t, n), trigger: "focus", placement: "auto " + r.errorTooltipPlacement, container: i, template: '<div class="tooltip' + (a ? " tooltip-" + a : "") + '" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>' }).tooltip("show") }, r.errorTooltipDelay) },
                    d = function(e, t, a) {
                        if (!e || !t || !angular.isString(e)) return 0;
                        var n = e.split(t),
                            i = n.length;
                        if (a)
                            for (var s = 0; s < n.length; s++) n[s] && "" !== n[s] && "" !== n[s].trim() || i--;
                        return i
                    },
                    u = function(e) { return "Bytes" === s.option.suffix ? function(e) { if (!e || parseInt(e).toString() != e) return e; for (var t = ["", "K", "M", "G"], a = 0, n = 0; n < t.length && !(e < 1024 || e % 1024 != 0); n++) e /= 1024, a++; return e + t[a] }(e) : e };
                s.optionStatus = (a = "ready", { getValue: function() { return a }, setReady: function() { l(), a = "ready" }, setPending: function() { l(), a = "pending" }, setSaving: function() { l(), a = "pending" }, setSuccess: function() { l(), a = "success" }, setFailed: function(e) { l(), a = "failed", c(e, "warning") }, setError: function(e, t) { l(), c(e, a = "error", t) }, getStatusFeedbackStyle: function() { return "success" === a ? "has-success" : "failed" === a ? "has-warning" : "error" === a ? "has-error" : "" }, getStatusIcon: function() { return "pending" === a ? "fa-hourglass-start" : "saving" === a ? "fa-spin fa-pulse fa-spinner" : "success" === a ? "fa-check" : "failed" === a ? "fa-exclamation" : "error" === a ? "fa-times" : "" }, isShowStatusIcon: function() { return "" !== this.getStatusIcon() } }), s.getTotalCount = function() {
                    var e = d(s.fixedValue, s.option.separator, s.option.trimCount),
                        t = d(s.optionValue, s.option.separator, s.option.trimCount);
                    return !s.optionValue && s.showPlaceholderCount && s.placeholderItemCount && (t = s.placeholderItemCount), e + t
                }, s.changeValue = function(e, t) {
                    if (o && p.cancel(o), s.optionValue = e, s.optionStatus.setReady(), s.option && s.option.key && !s.option.readonly)
                        ...
                        if ("" === e || "float" !== s.option.type || /^-?(\d*\.)?\d+$/.test(e)) {
                            if ("" !== e && ("integer" === s.option.type || "float" === s.option.type) && (angular.isDefined(s.option.min) || angular.isDefined(s.option.max))) { var a = e; if ("integer" === s.option.type ? a = parseInt(e) : "float" === s.option.type && (a = parseFloat(e)), angular.isDefined(s.option.min) && a < s.option.min) return void s.optionStatus.setError("Input number is below min value!", { value: s.option.min }); if (angular.isDefined(s.option.max) && a > s.option.max) return void s.optionStatus.setError("Input number is above max value!", { value: s.option.max }) }
                            if ("" === e || !angular.isDefined(s.option.pattern) || new RegExp(s.option.pattern).test(e)) {
                                var n = { key: s.option.key, value: e, optionStatus: s.optionStatus },
                                    i = function() { s.optionStatus.setSaving(), s.onChangeValue(n) };
                                s.onChangeValue && (t ? (s.optionStatus.setPending(), o = p(function() { i() }, r.lazySaveTimeout)) : i())
                            } else s.optionStatus.setError("Input value is invalid!")
                        } else s.optionStatus.setError("Input number is invalid!");
                    else s.optionStatus.setError("Input number is invalid!")
                }, s.inputKeyUp = function(e, t) {
                    if ((!0 === r.deleteKeyAlwaysChangeValue || "true" === r.deleteKeyAlwaysChangeValue) && (h.isBackspacePressed(e) || h.isDeletePressed(e))) {
                        if (s.optionValue && "" !== s.optionValue) return;
                        s.changeValue("", t)
                    }
                }, s.filterHistory = function(e) {
                    var t = [];
                    if (s.history && e)
                        for (var a = 0; a < s.history.length; a++) 0 === s.history[a].indexOf(e) && t.push(s.history[a]);
                    return g.resolve(t)
                }, t && s.$watch(function() { return t.$viewValue }, function(e) { s.optionValue = u(e) }), s.$watch("option", function() { n(), i.find('[data-toggle="popover"]').popover() }), s.$watch("defaultValue", function(e) {
                    var t = e;
                    if (s.option && s.option.options)
                        for (var a = 0; a < s.option.options.length; a++) { var n = s.option.options[a]; if (n.value === e) { t = n.name; break } } s.placeholder = u(t), s.option ? s.placeholderItemCount = d(s.placeholder, s.option.separator, s.option.trimCount) : s.placeholderItemCount = 0
                }), s.showPlaceholderCount = !0 === r.showPlaceholderCount || "true" === r.showPlaceholderCount, n()
            }
        }
    }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").directive("ngSettingDialog", ["ariaNgCommonService", "aria2SettingService", function(s, o) {
        return {
            restrict: "E",
            ...
            scope: { setting: "=" },
            link: function(n, i, e) {
                n.context = { isLoading: !1, availableOptions: [], globalOptions: [] }, n.setGlobalOption = function(e, t, a) { return o.setGlobalOption(e, t, function(e) { e.success && "OK" === e.data ? a.setSuccess() : a.setFailed(e.data.message) }, !0) };
                angular.element(i).on("hidden.bs.modal", function() { n.$apply(function() { n.setting = null, n.context.availableOptions = [], n.context.globalOptions = [] }) }), n.$watch("setting", function(e) {
                    var t, a;
                    e && (t = e.type, (a = o.getAria2QuickSettingsAvailableOptions(t)) ? n.context.availableOptions = o.getSpecifiedOptions(a) : s.showError("Type is illegal!"), n.context.isLoading = !0, o.getGlobalOption(function(e) { n.context.isLoading = !1, e.success && (n.context.globalOptions = e.data) }), angular.element(i).modal("show"))
                }, !0)
            }
        }
    }])
...
function() {
    ...
    angular.module("ariaNg").directive("ngTooltip", function() {
        return {
            ...
            link: function(e, t, a) {
                var n = { ngTooltipIf: !0, ngTooltipPlacement: "top", ngTooltipContainer: null, ngTooltipTrigger: "hover" };
                angular.extend(n, a);
                var i = !0 === n.ngTooltipIf || "true" === n.ngTooltipIf,
                    s = function() { angular.element(t).tooltip({ title: e.title, placement: n.ngTooltipPlacement, container: n.ngTooltipContainer, trigger: n.ngTooltipTrigger, delay: { show: 100, hide: 0 } }) };
                i && s(), e.$watch("title", function() { i && angular.element(t).attr("title", e.title).tooltip("fixTitle") }), e.$watch("ngTooltipIf", function(e) { angular.isUndefined(e) || i !== (e = !0 === e || "true" === e) && (e ? s() : angular.element(t).tooltip("destroy"), i = e) })
            }
        }
    })
}(),
    ...
    angular.module("ariaNg").directive("ngValidUrls", ["ariaNgCommonService", function(i) {
        return {
            ...
            link: function(e, t, a, n) {
                e.$watch(function() { return n.$viewValue }, function(e) {
...
function() {
    "use strict";
    angular.module("ariaNg").directive("ngBlobDownload", ["ariaNgFileService", function(n) { return { restrict: "A", scope: { ngBlobDownload: "=ngBlobDownload", ngFileName: "@", ngContentType: "@" }, link: function(t, a) { t.$watch("ngBlobDownload", function(e) { e && n.saveFileContent(e, a, { fileName: t.ngFileName, contentType: t.ngContentType }) }) } } }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").filter("dateDuration", ["moment", function(i) { return function(e, t, a) { var n = i.duration(e, t); return i.utc(n.asMilliseconds()).format(a) } }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").filter("fileOrderBy", ["$filter", "ariaNgCommonService", function(n, i) { return function(e, t) { if (!angular.isArray(e) || !t) return e; var a = i.parseOrderType(t); return null === a ? e : "index" === a.type ? n("orderBy")(e, ["index"], a.reverse) : "name" === a.type ? n("orderBy")(e, ["fileName"], a.reverse) : "size" === a.type ? n("orderBy")(e, ["length"], a.reverse) : "percent" === a.type ? n("orderBy")(e, ["completePercent"], a.reverse) : "selected" === a.type ? n("orderBy")(e, ["selected"], a.reverse) : e } }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").filter("logOrderBy", ["$filter", "ariaNgCommonService", function(n, i) { return function(e, t) { if (!angular.isArray(e) || !t) return e; var a = i.parseOrderType(t); return null === a ? e : "time" === a.type ? n("orderBy")(e, ["time"], a.reverse) : e } }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").filter("longDate", ["ariaNgCommonService", "ariaNgLocalizationService", function(a, n) { return function(e) { var t = n.getLongDateFormat(); return a.formatDateTime(e, t) } }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").filter("peerOrderBy", ["$filter", "ariaNgCommonService", function(n, i) { return function(e, t) { if (!angular.isArray(e)) return e; var a = i.parseOrderType(t); return null === a ? e : "address" === a.type ? n("orderBy")(e, ["ip", "port"], a.reverse) : "client" === a.type ? n("orderBy")(e, ["client.name", "client.version"], a.reverse) : "percent" === a.type ? n("orderBy")(e, ["completePercent"], a.reverse) : "dspeed" === a.type ? n("orderBy")(e, ["downloadSpeed"], a.reverse) : "uspeed" === a.type ? n("orderBy")(e, ["uploadSpeed"], a.reverse) : e } }])
}(),
function() {
    "use strict";
...
function() {
    "use strict";
    angular.module("ariaNg").filter("reverse", function() { return function(e) { return e ? e.slice().reverse() : e } })
}(),
function() {
    "use strict";
...
function() {
    "use strict";
    angular.module("ariaNg").filter("timeDisplayName", ["ariaNgCommonService", "ariaNgLocalizationService", function(n, i) { return function(e, t) { if (!e) return i.getLocalizedText(t); var a = n.getTimeOption(e); return i.getLocalizedText(a.name, { value: a.value }) } }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").filter("readableVolume", ["$filter", function(r) {
        var l = ["B", "KB", "MB", "GB"];
        return function(e, t) {
            var a, n = l[0],
                i = 2,
...
function() {
    ...
    angular.module("ariaNg").provider("ariaNgAssetsCacheService", [function() {
        ...
        }, this.$get = function() { var t = this; return { getLanguageAsset: function(e) { return t.getLanguageAsset(e) } } }
    }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgLanguageLoader", ["$http", "$q", "ariaNgConstants", "ariaNgLanguages", "ariaNgAssetsCacheService", "ariaNgNotificationService", "ariaNgLogService", "ariaNgStorageService", function(o, r, l, c, d, u, p, g) {
        var f = function(e) {
                for (var t = 0; t < e.length; t++)
                    if (0 < t && "\\" !== e.charAt(t - 1) && "=" === e.charAt(t)) return { key: e.substring(0, t).replace("\\=", "="), value: e.substring(t + 1, e.length).replace("\\=", "=") };
                return { value: e }
            },
            m = function(e, t) {
                var a = e;
            ...
            h = function(e) {
                ...
                for (var a = e.split("\n"), n = t, i = 0; i < a.length; i++) {
                    var s = a[i];
                    if (s)
                        if (s = s.replace("\r", ""), /^\[.+\]$/.test(s)) n = m(t, s);
                        else {
                            var o = f(s);
            ...
            v = function(e, t) {
                ...
                for (var a in t)
                    if (t.hasOwnProperty(a)) { var n = t[a]; if (angular.isObject(n)) { if (!v(e[a], n)) return !1 } else if (n !== e[a]) return !1 } return !0
            };
        return function(t) {
            var n = r.defer();
            ...
            var i = l.languageStorageKeyPrefix + "." + t.key,
                s = g.get(i);
            if (s && n.resolve(s), d.getLanguageAsset(t.key)) { var e = h(d.getLanguageAsset(t.key)); return g.set(i, e), n.resolve(e), n.promise }
            var a = l.languagePath + "/" + t.key + l.languageFileExtension;
            return o({ url: a, method: "GET" }).then(function(e) {
                var t = h(e.data),
                    a = !1;
                return s && (a = !v(s, t)), g.set(i, t), a ? (p.info("[ariaNgLanguageLoader] load language resource successfully, and resource is updated"), u.notifyInPage("", "Language resource has been updated, please reload the page for the changes to take effect.", { delay: !1, type: "info", templateUrl: "views/notification-reloadable.html" })) : p.info("[ariaNgLanguageLoader] load language resource successfully, but resource is not updated"), n.resolve(t)
            }).catch(function(e) { return p.warn("[ariaNgLanguageLoader] cannot get language resource"), s || u.notifyInPage("", "AriaNg cannot get language resources, and will display in default language.", { type: "error", delay: !1 }), n.reject(t.key) }), n.promise
        }
    }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgCommonService", ["$window", "$location", "$timeout", "base64", "moment", "SweetAlert", "ariaNgConstants", "ariaNgLocalizationService", function(e, t, d, a, n, u, i, p) {
        var o = function(e) { var t = e; return { name: e < 1e3 ? 1 === (t = e) ? "format.time.millisecond" : "format.time.milliseconds" : e < 6e4 ? 1 === (t = e / 1e3) ? "format.time.second" : "format.time.seconds" : e < 144e4 ? 1 === (t = e / 1e3 / 60) ? "format.time.minute" : "format.time.minutes" : 1 === (t = e / 1e3 / 60 / 24) ? "format.time.hour" : "format.time.hours", value: t, optionValue: e } };
        return {
            getFullPageUrl: function() { return e.location.protocol + "//" + e.location.host + e.location.pathname + (e.location.search ? e.location.search : "") },
            base64Encode: function(e) { return a.encode(e) },
            base64Decode: function(e) { return a.decode(e) },
            base64UrlEncode: function(e) { return a.urlencode(e) },
            base64UrlDecode: function(e) { return a.urldecode(e) },
            generateUniqueId: function() { var e = i.appPrefix + "_" + Math.round((new Date).getTime() / 1e3) + "_" + Math.random(); return this.base64Encode(e) },
            showDialog: function(e, t, a, n, i) {
                var s, o, r, l, c;
                i || (i = {}), e && (e = p.getLocalizedText(e)), t && (t = p.getLocalizedText(t, i.textParams)), i.confirmButtonText = p.getLocalizedText("OK"), s = e, o = t, r = a, l = n, c = i, d(function() { u.swal({ title: s, text: o, type: r, confirmButtonText: c && c.confirmButtonText || null }, function() { l && l() }) }, 100)
            },
            showInfo: function(e, t, a, n) { this.showDialog(e, t, "info", a, n) },
            showError: function(e, t, a) { this.showDialog("Error", e, "error", t, a) },
            showOperationSucceeded: function(e, t) { this.showDialog("Operation Succeeded", e, "success", t) },
            confirm: function(e, t, a, n, i, s) {
                var o, r, l, c, d;
                s || (s = {}), e && (e = p.getLocalizedText(e)), t && (t = p.getLocalizedText(t, s.textParams)), s.confirmButtonText = p.getLocalizedText("OK"), s.cancelButtonText = p.getLocalizedText("Cancel"), r = n, d = { title: e, text: t, type: o = a, showCancelButton: !0, showLoaderOnConfirm: !!(l = i), closeOnConfirm: !l, confirmButtonText: (c = s) && c.confirmButtonText || null, cancelButtonText: c && c.cancelButtonText || null }, "warning" === o && (d.confirmButtonColor = "#F39C12"), u.swal(d, function(e) { e && r && r() })
            },
            closeAllDialogs: function() { u.close() },
            getFileExtension: function(e) { return !e || e.lastIndexOf(".") < 0 ? e : e.substring(e.lastIndexOf(".")) },
            ...
            pushArrayTo: function(e, t) { if (angular.isArray(e) || (e = []), !angular.isArray(t) || t.length < 1) return e; for (var a = 0; a < t.length; a++) e.push(t[a]); return e },
            combineArray: function() { for (var e = [], t = 0; t < arguments.length; t++) angular.isArray(arguments[t]) ? this.pushArrayTo(e, arguments[t]) : e.push(arguments[t]); return e },
            countArray: function(e, t) { if (!angular.isArray(e) || e.length < 1) return 0; for (var a = 0, n = 0; n < e.length; n++) a += e[n] === t ? 1 : 0; return a },
            parseOrderType: function(e) {
                var t = e.split(":"),
                    a = { type: t[0], order: t[1], equals: function(e) { return angular.isUndefined(e.order) ? this.type === e.type : this.type === e.type && this.order === e.order }, getValue: function() { return this.type + ":" + this.order } };
                return Object.defineProperty(a, "reverse", { get: function() { return "desc" === this.order }, set: function(e) { this.order = e ? "desc" : "asc" } }), a
            },
            getCurrentUnixTime: function() { return n().format("X") },
            getLongTimeFromUnixTime: function(e) { return n(e, "X").format("HH:mm:ss") },
            isUnixTimeAfter: function(e, t, a) { return n(e, "X").isAfter(n().add(t, a)) },
            formatDateTime: function(e, t) { return n(e).format(t) },
            getTimeOption: function(e) { return o(e) },
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgKeyboardService", ["$window", function(e) {
        var t = "";
        e.navigator && e.navigator.userAgentData && e.navigator.userAgentData.platform ? t = e.navigator.userAgentData.platform : e.navigator && e.navigator.platform && (t = e.navigator.platform);
        var a = /(Mac|iPhone|iPod|iPad)/i.test(t),
            n = function(e) { return a ? e.metaKey : e.ctrlKey },
            i = function(e) { return e.keyCode || e.which || e.charCode };
        return { isMacKeyboardLike: function() { return a }, isCtrlAPressed: function(e) { return n(e) && ("KeyA" === e.code || 65 === i(e)) }, isCtrlFPressed: function(e) { return n(e) && ("KeyF" === e.code || 70 === i(e)) }, isCtrlEnterPressed: function(e) { return n(e) && ("Enter" === e.code || 13 === i(e)) }, isBackspacePressed: function(e) { return "Backspace" === e.code || 8 === i(e) }, isDeletePressed: function(e) { return "Delete" === e.code || 46 === i(e) } }
    }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgNotificationService", ["$window", "Notification", "ariaNgConstants", "ariaNgCommonService", "ariaNgStorageService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", function(n, o, i, s, r, l, c, d) {
        var u = !!n.Notification,
            p = function(e) { return "granted" === e },
            a = function() { return n.Notification ? n.Notification.permission : null },
            g = function(e, t) {
                n.Notification && p(a()) && (function() {
                    if (!d.getBrowserNotificationFrequency() || "unlimited" === d.getBrowserNotificationFrequency()) return !1;
                    var e = r.get(i.browserNotificationHistoryStorageKey) || [];
                    if (!angular.isArray(e)) return !1;
                    if (e.length < 1) return !1;
                    var t = null,
                        a = !1;
                    if ("high" === d.getBrowserNotificationFrequency()) {
                        if (e.length < 10) return !1;
                        t = e[e.length - 10].time, a = s.isUnixTimeAfter(t, "-1", "minute")
                    } else "middle" === d.getBrowserNotificationFrequency() ? (t = e[e.length - 1].time, a = s.isUnixTimeAfter(t, "-1", "minute")) : "low" === d.getBrowserNotificationFrequency() && (t = e[e.length - 1].time, a = s.isUnixTimeAfter(t, "-5", "minute"));
                    return a && c.debug("[ariaNgNotificationService.isReachBrowserNotificationFrequencyLimit] reach frequency limit" + (t ? ", the oldest time is " + t : "")), a
                }() || (t = angular.extend({ icon: "tileicon.png" }, t), function() {
                    if (d.getBrowserNotificationFrequency() && "unlimited" !== d.getBrowserNotificationFrequency()) {
                        var e = r.get(i.browserNotificationHistoryStorageKey) || [];
                        angular.isArray(e) || (e = []), e.push({ time: s.getCurrentUnixTime() }), 10 < e.length && e.splice(0, e.length - 10), r.set(i.browserNotificationHistoryStorageKey, e)
                    }
                }(), new n.Notification(e, t)))
            };
        return {
            isSupportBrowserNotification: function() { return u },
            hasBrowserPermission: function() { return !!u && p(a()) },
            requestBrowserPermission: function(t) {
                var a;
                u && (a = function(e) { e.granted || d.setBrowserNotification(!1), t && t(e) }, n.Notification && n.Notification.requestPermission(function(e) { a && a({ granted: p(e), permission: e }) }))
            },
            notifyViaBrowser: function(e, t, a) { return a || (a = {}), e && (e = l.getLocalizedText(e, a.titleParams)), t && (t = l.getLocalizedText(t, a.contentParams)), n = e, i = t, (s = a) || (s = {}), s.body = i, d.getBrowserNotificationSound() || (s.silent = !0), void(u && d.getBrowserNotification() && g(n, s)); var n, i, s },
            notifyTaskComplete: function(e) { this.notifyViaBrowser("Download Completed", e && e.taskName ? e.taskName : "") },
            notifyBtTaskComplete: function(e) { this.notifyViaBrowser("BT Download Completed", e && e.taskName ? e.taskName : "") },
            notifyTaskError: function(e) { this.notifyViaBrowser("Download Error", e && e.taskName ? e.taskName : "") },
            notifyInPage: function(e, t, a) { return a || (a = {}), e && (e = l.getLocalizedText(e, a.titleParams)), t && (t = l.getLocalizedText(t, a.contentParams), a.contentPrefix && (t = a.contentPrefix + t)), n = e, (s = a) || (s = {}), (i = t) ? (s.title = n, s.message = i) : s.message = n, s.type && o[s.type] || (s.type = "primary"), s.positionY || (s.positionY = "top"), o[s.type](s); var n, i, s },
            clearNotificationInPage: function() { o.clearAll() }
        }
    }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgLocalizationService", ["$translate", "amMoment", function(a, t) { return { applyLanguage: function(e) { return a.use(e), t.changeLocale(e), !0 }, getLocalizedText: function(e, t) { return a.instant(e, t) }, getLongDateFormat: function() { return this.getLocalizedText("format.longdate") } } }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgLogService", ["$log", "ariaNgConstants", function(a, o) {
        var i = { DEBUG: 1, INFO: 2, WARN: 3, ERROR: 4 },
            ...
            n = function(e, t, a) {
                var n, i, s;
                l && (c.length >= o.cachedDebugLogsLimit && c.shift(), c.push((n = e, i = t, s = a, { id: ++r, time: new Date, level: i, content: n, attachment: s })))
            };
        return {
            setEnableDebugLog: function(e) { l = e },
            compareLogLevel: function(e, t) {
                var a = i[e],
                    n = i[t];
                return a || (a = 0), n || (n = 0), n < a ? 1 : a < n ? -1 : 0
            },
            debug: function(e, t) { l && (t ? a.debug("[AriaNg Debug]" + e, t) : a.debug("[AriaNg Debug]" + e), n(e, "DEBUG", t)) },
            info: function(e, t) { t ? a.info("[AriaNg Info]" + e, t) : a.info("[AriaNg Info]" + e), n(e, "INFO", t) },
            warn: function(e, t) { t ? a.warn("[AriaNg Warn]" + e, t) : a.warn("[AriaNg Warn]" + e), n(e, "WARN", t) },
            error: function(e, t) { t ? a.error("[AriaNg Error]" + e, t) : a.error("[AriaNg Error]" + e), n(e, "ERROR", t) },
            getDebugLogs: function() { return l ? c : [] },
            clearDebugLogs: function() { r = 0, c.length = 0 }
        }
    }])
}(),
function() {
...
function() {
    ...
    angular.module("ariaNg").factory("ariaNgFileService", ["$window", function(e) {
        var n = !!e.FileReader,
            s = !!e.Blob;
        return {
            isSupportFileReader: function() { return n },
            isSupportBlob: function() { return s },
            openFileContent: function(e, t, a, s) {
                n ? (e = angular.extend({ scope: null, fileFilter: null, fileType: "binary", successCallback: t, errorCallback: a }, e), s && s.change || (s = angular.element('<input type="file" style="display: none"/>')), s.data("options", e), e.fileFilter && s.attr("accept", e.fileFilter), s.val(""), "true" !== s.attr("data-ariang-file-initialized") && s.change(function() {
                    if (this.files && !(this.files.length < 1)) {
                        var t = s.data("options"),
                            e = function(e) { var t = []; if (!e || e.length < 1) return t.push(/.+$/), t; for (var a = e.split(","), n = 0; n < a.length; n++) { var i = a[n]; "*.*" !== i ? (i = i.replace(".", "\\."), i += "$", t.push(new RegExp(i))) : t.push(/.+$/) } return t }(t.fileFilter),
                            a = this.files[0],
                            n = a.name;
                        if (function(e, t) {
                            ...
                            switch (i.onload = function() {
                                ...
                                t.successCallback && (t.scope ? t.scope.$apply(function() { t.successCallback(e) }) : t.successCallback(e))
                            }, i.onerror = function() { t.errorCallback && (t.scope ? t.scope.$apply(function() { t.errorCallback("Failed to load file!") }) : t.errorCallback("Failed to load file!")) }, t.fileType) {
                                case "text":
                                    i.readAsText(a);
                                    break;
                                case "binary":
                        ...
                        } else t.errorCallback && (t.scope ? t.scope.$apply(function() { t.errorCallback("The selected file type is invalid!") }) : t.errorCallback("The selected file type is invalid!"))
                    }
                }).attr("data-ariang-file-initialized", "true"), s.trigger("click")) : a && a("Your browser does not support loading file!")
            },
            saveFileContent: function(e, t, a) {
                if (s) {
                    a = angular.extend({ fileName: null, contentType: "application/octet-stream", autoTrigger: !1, autoRevoke: !1 }, a);
                    var n = new Blob([e], { type: a.contentType }),
                        i = URL.createObjectURL(n);
                    t || (t = angular.element('<a style="display: none"/>')), t.attr("href", i), a.fileName && t.attr("download", a.fileName), a.autoTrigger && t.trigger("click"), a.autoRevoke && URL.revokeObjectURL(i)
                }
            }
        }
    }])
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgSettingService", ["$window", "$location", "$filter", "ariaNgConstants", "ariaNgDefaultOptions", "ariaNgLanguages", "ariaNgCommonService", "ariaNgLogService", "ariaNgStorageService", function(n, t, e, i, o, s, r, l, c) {
        var a = { localStroage: c.isLocalStorageSupported(), cookies: c.isCookiesSupported() },
            d = a.localStroage || a.cookies,
            u = !!n.matchMedia && n.matchMedia("(prefers-color-scheme: dark)") && "not all" !== n.matchMedia("(prefers-color-scheme: dark)").media && angular.isFunction(n.matchMedia("(prefers-color-scheme: dark)").addEventListener),
            p = [],
            g = !1,
            f = { debugMode: !1 },
            m = function() { return "https" === t.protocol() },
            h = function(e) {
                for (var t in s)
            ...
            v = function() {
                ...
                (e = e.replace(/\-/g, "_"), s[e]) || (t = h(e)) && (e = t);
                if (!s[e] && 1 < e.split("-").length) { var t, a = e.split("-"); if (e = a[0] + "-" + a[1], !s[e])(t = h(e)) && (e = t) }
                return s[e] ? (l.info('[ariaNgSettingService] use browser language "' + e + '" as current language'), e) : (l.info('[ariaNgSettingService] browser language "' + e + '" not support, use default language'), o.language)
            },
            y = function(e) { return c.set(i.optionStorageKey, e) },
            b = function() {
                var e, t = c.get(i.optionStorageKey);
                if (t && !s[t.language] && (t.language = (e = t.language, h(e) || v())), !t) {
                    if ((t = angular.extend({}, o)).language = v(), t.rpcHost || S(t), angular.isArray(t.extendRpcServers))
                    ...
                    y(t),
                        function() {
                            if (d && !(g || !angular.isArray(p) || p.length < 1)) {
                                for (var e = 0; e < p.length; e++)(0, p[e])();
                                g = !0
                            }
                        }()
                }
            ...
            k = function(e) { var t = b(); return angular.isUndefined(t[e]) && angular.isDefined(o[e]) && (t[e] = o[e], y(t)), t[e] },
            w = function(e, t) {
                var a = b();
                a[e] = t, y(a)
            },
            S = function(e) { e.rpcHost = t.host() || i.defaultHost, m() && (e.protocol = i.defaultSecureProtocol) },
            x = function(e) { return { rpcAlias: e.rpcAlias, rpcHost: e.rpcHost, rpcPort: e.rpcPort, rpcInterface: e.rpcInterface, protocol: e.protocol, httpMethod: e.httpMethod, rpcRequestHeaders: e.rpcRequestHeaders, secret: e.secret } },
            T = function() { var e = x(o); return e.rpcId = r.generateUniqueId(), S(e), e };
        return {
            isBrowserSupportStorage: function() { return d },
            isBrowserSupportDarkMode: function() { return u },
            getBrowserFeatures: function() { return a },
            getAllOptions: function() {
                var e = angular.extend({}, o, b());
            ...
            getAllRpcSettings: function() {
                ...
                if (a.isDefault = !0, e.push(a), angular.isArray(t.extendRpcServers))
                    for (var n = 0; n < t.extendRpcServers.length; n++) {
                        var i = x(t.extendRpcServers[n]);
                        i.rpcId = t.extendRpcServers[n].rpcId, i.isDefault = !1, e.push(i)
                    }
                var s = this.getRPCListDisplayOrder();
                return "recentlyUsed" === s || "rpcAlias" === s && e.sort(function(e, t) { return String.naturalCompare(e.rpcAlias, t.rpcAlias) }), e
            },
            ...
            exportAllOptions: function() { return angular.extend({}, o, b()) },
            getAllSessionOptions: function() { return angular.copy(f) },
            isInsecureProtocolDisabled: function() { return m() },
            getLanguage: function() { return k("language") },
            setLanguage: function(e) { return !!s[e] && (w("language", e), !0) },
            getTheme: function() { return k("theme") },
            setTheme: function(e) { return w("theme", e), !0 },
            isEnableDebugMode: function() { return f.debugMode },
            setDebugMode: function(e) { f.debugMode = e, l.setEnableDebugLog(e) },
            getTitle: function() { return k("title") },
            setTitle: function(e) { w("title", e) },
            getBrowserNotification: function() { return k("browserNotification") },
            setBrowserNotification: function(e) { w("browserNotification", e) },
            getBrowserNotificationSound: function() { return k("browserNotificationSound") },
            setBrowserNotificationSound: function(e) { w("browserNotificationSound", e) },
            getBrowserNotificationFrequency: function() { return k("browserNotificationFrequency") },
            setBrowserNotificationFrequency: function(e) { w("browserNotificationFrequency", e) },
            getWebSocketReconnectInterval: function() { return k("webSocketReconnectInterval") },
            setWebSocketReconnectInterval: function(e) { w("webSocketReconnectInterval", e) },
            getTitleRefreshInterval: function() { return k("titleRefreshInterval") },
            setTitleRefreshInterval: function(e) { w("titleRefreshInterval", Math.max(parseInt(e), 0)) },
            getGlobalStatRefreshInterval: function() { return k("globalStatRefreshInterval") },
            setGlobalStatRefreshInterval: function(e) { w("globalStatRefreshInterval", Math.max(parseInt(e), 0)) },
            getDownloadTaskRefreshInterval: function() { return k("downloadTaskRefreshInterval") },
            setDownloadTaskRefreshInterval: function(e) { w("downloadTaskRefreshInterval", Math.max(parseInt(e), 0)) },
            getKeyboardShortcuts: function() { return k("keyboardShortcuts") },
            setKeyboardShortcuts: function(e) { w("keyboardShortcuts", e) },
            getSwipeGesture: function() { return k("swipeGesture") },
            setSwipeGesture: function(e) { w("swipeGesture", e) },
            getDragAndDropTasks: function() { return k("dragAndDropTasks") },
            setDragAndDropTasks: function(e) { w("dragAndDropTasks", e) },
            getRPCListDisplayOrder: function() { return k("rpcListDisplayOrder") },
            setRPCListDisplayOrder: function(e) { w("rpcListDisplayOrder", e) },
            getAfterCreatingNewTask: function() { return k("afterCreatingNewTask") },
            setAfterCreatingNewTask: function(e) { w("afterCreatingNewTask", e) },
            getRemoveOldTaskAfterRetrying: function() { return k("removeOldTaskAfterRetrying") },
            setRemoveOldTaskAfterRetrying: function(e) { w("removeOldTaskAfterRetrying", e) },
            getConfirmTaskRemoval: function() { return k("confirmTaskRemoval") },
            setConfirmTaskRemoval: function(e) { w("confirmTaskRemoval", e) },
            getIncludePrefixWhenCopyingFromTaskDetails: function() { return k("includePrefixWhenCopyingFromTaskDetails") },
            setIncludePrefixWhenCopyingFromTaskDetails: function(e) { w("includePrefixWhenCopyingFromTaskDetails", e) },
            getShowPiecesInfoInTaskDetailPage: function() { return k("showPiecesInfoInTaskDetailPage") },
            setShowPiecesInfoInTaskDetailPage: function(e) { w("showPiecesInfoInTaskDetailPage", e) },
            getAfterRetryingTask: function() { return k("afterRetryingTask") },
            setAfterRetryingTask: function(e) { w("afterRetryingTask", e) },
            getCurrentRpcDisplayName: function() { var e = b(); return e.rpcAlias ? e.rpcAlias : e.rpcHost + ":" + e.rpcPort },
            getCurrentRpcUrl: function() { var e = b(); return e.protocol + "://" + e.rpcHost + ":" + e.rpcPort + "/" + e.rpcInterface },
            getCurrentRpcHttpMethod: function() { return k("httpMethod") },
            getCurrentRpcRequestHeaders: function() { return k("rpcRequestHeaders") },
            isCurrentRpcUseWebSocket: function(e) { e || (e = b().protocol); return "ws" === e || "wss" === e },
            getCurrentRpcSecret: function() { var e = k("secret"); return e ? r.base64Decode(e) : e },
            addNewRpcSetting: function() {
                var e = b();
                angular.isArray(e.extendRpcServers) || (e.extendRpcServers = []);
                var t = T();
                return e.extendRpcServers.push(t), y(e), t
            },
            updateRpcSetting: function(e, t) {
                ...
                var n = a[t];
                if ("rpcPort" === t ? n = Math.max(parseInt(n), 0) : "secret" === t && n && (n = r.base64Encode(n)), e.isDefault) return w(t, n), e;
                var i = b();
                if (!angular.isArray(i.extendRpcServers)) return e;
                for (var s = 0; s < i.extendRpcServers.length; s++)
                    if (i.extendRpcServers[s].rpcId === e.rpcId) { i.extendRpcServers[s][t] = n; break } return y(i), e
            },
            removeRpcSetting: function(e) {
                var t = b();
                if (!angular.isArray(t.extendRpcServers)) return e;
                for (var a = 0; a < t.extendRpcServers.length; a++)
                    if (t.extendRpcServers[a].rpcId === e.rpcId) { t.extendRpcServers.splice(a, 1); break } return y(t), e
            },
            setDefaultRpcSetting: function(e, t) {
                ...
                for (var i = null, s = 0; s < a.extendRpcServers.length; s++)
                    if (a.extendRpcServers[s].rpcId === e.rpcId) { i = x(a.extendRpcServers[s]), a.extendRpcServers.splice(s, 1); break } return t.forceSet && (i = x(e)).secret && (i.secret = r.base64Encode(i.secret)), i && (t.keepCurrent && a.extendRpcServers.splice(0, 0, n), a = angular.extend(a, i)), y(a), e
            },
            isRpcSettingEqualsDefault: function(e) { if (!e) return !1; var t = this.getAllOptions(); return t.rpcHost === e.rpcHost && (t.rpcPort === e.rpcPort && (t.rpcInterface === e.rpcInterface && (t.protocol === e.protocol && (t.httpMethod === e.httpMethod && (t.rpcRequestHeaders === e.rpcRequestHeaders && t.secret === e.secret))))) },
            getTaskListIndependentDisplayOrder: function() { return k("taskListIndependentDisplayOrder") },
            setTaskListIndependentDisplayOrder: function(e) { w("taskListIndependentDisplayOrder", e) },
            getTaskListDisplayOrderKey: function(e) { var t = "displayOrder"; return this.getTaskListIndependentDisplayOrder() && ("waiting" === e ? t = "waitingTaskListPageDisplayOrder" : "stopped" === e && (t = "stoppedTaskListPageDisplayOrder")), t },
            getDisplayOrder: function(e) {
                var t = this.getTaskListDisplayOrderKey(e),
                    a = k(t);
                return a || (a = "default:asc"), a
            },
            setDisplayOrder: function(e, t) {
                var a = this.getTaskListDisplayOrderKey(t);
                w(a, e)
            },
            getFileListDisplayOrder: function() { var e = k("fileListDisplayOrder"); return e || (e = "default:asc"), e },
            setFileListDisplayOrder: function(e) { w("fileListDisplayOrder", e) },
            getPeerListDisplayOrder: function() { var e = k("peerListDisplayOrder"); return e || (e = "default:asc"), e },
            setPeerListDisplayOrder: function(e) { w("peerListDisplayOrder", e) },
            resetSettings: function() { c.clearAll() },
            onFirstAccess: function(e) { e && p.push(e) }
        }
    }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgMonitorService", ["$filter", "ariaNgConstants", "ariaNgCommonService", "ariaNgLocalizationService", function(o, t, l, r) {
        var a = {},
            c = {},
            n = "global",
            d = function(e) { return e === n ? t.globalStatStorageCapacity : t.taskStatStorageCapacity },
            u = function(e) {
                for (var t = {
                        legend: { show: !1 },
                        ...
                        tooltip: {
                            ...
                            formatter: function(e) {
                                ...
                                return '<div><i class="fa fa-clock-o"></i> ' + t + '</div><div><i class="icon-download fa fa-arrow-down"></i> ' + (o("readableVolume")(e[1].value) + "/s") + '</div><div><i class="icon-upload fa fa-arrow-up"></i> ' + a + "</div>"
                            }
                        },
                        xAxis: { data: [], type: "category", boundaryGap: !1, axisLabel: { show: !1 } },
                        yAxis: { type: "value", axisLabel: { formatter: function(e) { return o("readableVolume")(e, "auto") } } },
                        series: [{ type: "line", areaStyle: { normal: { opacity: .1 } }, smooth: !0, symbolSize: 6, showAllSymbol: !1, data: [] }, { type: "line", areaStyle: { normal: { opacity: .1 } }, smooth: !0, symbolSize: 6, showAllSymbol: !1, data: [] }]
                    }, a = t.xAxis.data, n = t.series[0].data, i = t.series[1].data, s = 0; s < d(e); s++) a.push(""), n.push(""), i.push("");
                return c[e] = t
            },
            p = function(e) { return angular.isDefined(c[e]) };
        return {
            recordStat: function(e, t) {
                var a, n, i, s, o, r;
                p(e) || u(e), t.time = l.getCurrentUnixTime(), n = t, i = c[a = e], s = i.xAxis.data, o = i.series[0].data, r = i.series[1].data, s.length >= d(a) && (s.shift(), o.shift(), r.shift()), s.push(n.time), o.push(n.uploadSpeed), r.push(n.downloadSpeed)
            },
            getStatsData: function(e) { return p(e) || u(e), c[e] },
            getEmptyStatsData: function(e) { return p(e) && delete c[e], this.getStatsData(e) },
            recordGlobalStat: function(e) { this.recordStat(n, e), a = e },
            getGlobalStatsData: function() { return this.getStatsData(n) },
            getCurrentGlobalStat: function() { return a }
        }
    }])
}(),
function() {
    ...
    angular.module("ariaNg").factory("ariaNgTitleService", ["$filter", "ariaNgConstants", "ariaNgLocalizationService", "ariaNgSettingService", function(d, f, m, h) {
        var u = function(e) {
            ...
            v = function(e, t, a) {
                var n, i, s, o = new RegExp("\\$\\{" + t + "(:[a-zA-Z0-9]+(=[a-zA-Z0-9]+)?)*\\}", "g"),
                    r = e.match(o);
                if (r && 0 < r.length)
                    for (var l = 0; l < r.length; l++) {
                        var c = u(r[l]);
                        angular.extend(c, a), n = e, s = void 0, s = (i = c).value, "volume" === i.type && (s = d("readableVolume")(s, i.scale)), i.prefix && !i.noprefix && (s = i.prefix + s), i.suffix && !i.nosuffix && (s += i.suffix), e = n.replace(i.oldValue, s)
                    }
                return e
            };
...
function() {
    "use strict";
    angular.module("ariaNg").factory("ariaNgVersionService", ["ariaNgBuildConfiguration", function(e) { return { getBuildVersion: function() { return e.buildVersion }, getBuildCommit: function() { return e.buildCommit } } }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2HttpRpcService", ["$http", "ariaNgConstants", "ariaNgCommonService", "ariaNgSettingService", "ariaNgLogService", function(r, l, c, e, d) {
        var u = e.getCurrentRpcUrl(),
            p = e.getCurrentRpcHttpMethod(),
            g = e.getCurrentRpcRequestHeaders();
        return {
            request: function(a) {
                if (a) {
                    var e = { url: u, method: p, headers: {}, timeout: l.httpRequestTimeout };
                    if ("POST" === e.method ? (e.data = angular.toJson(a.requestBody), e.headers["Content-Type"] = "application/json") : "GET" === e.method && (e.url = function(e, t) {
                            if (!e || e.length < 1) return e;
                            var a = "";
                            for (var n in t)
                                if (t.hasOwnProperty(n)) {
                                    var i = t[n];
                                    null === i || angular.isUndefined(i) || (0 < a.length && (a += "&"), (angular.isObject(i) || angular.isArray(i)) && (i = angular.toJson(i), i = c.base64Encode(i), i = encodeURIComponent(i)), a += n + "=" + i)
                                } return a.length < 1 ? e : (a = e.indexOf("?") < 0 ? "?" + a : "&" + a, e + a)
                        }(e.url, a.requestBody)), g)
                        for (var t = g.split("\n"), n = 0; n < t.length; n++) {
                            var i = t[n].split(":");
                            if (2 === i.length) {
                                var s = i[0].trim(),
                    ...
                    return d.debug("[aria2HttpRpcService.request] " + (a && a.requestBody && a.requestBody.method ? a.requestBody.method + " " : "") + "request start", e), r(e).then(function(e) {
                        var t = e.data;
                        d.debug("[aria2HttpRpcService.request] " + (a && a.requestBody && a.requestBody.method ? a.requestBody.method + " " : "") + "response success", e), t && (a.connectionSuccessCallback && a.connectionSuccessCallback({ rpcUrl: u, method: p }), a.successCallback && a.successCallback(t.id, t.result))
                    }).catch(function(e) {
                        var t = e.data;
                        d.debug("[aria2HttpRpcService.request] " + (a && a.requestBody && a.requestBody.method ? a.requestBody.method + " " : "") + "response error", e), t || (t = { id: "-1", error: { message: "Cannot connect to aria2!" } }, a.connectionFailedCallback && a.connectionFailedCallback({ rpcUrl: u, method: p })), a.errorCallback && a.errorCallback(t.id, t.error)
                    })
                }
            },
            reconnect: function() {},
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2WebSocketRpcService", ["$q", "$websocket", "$timeout", "ariaNgConstants", "ariaNgSettingService", "ariaNgLogService", function(s, e, t, a, n, o) {
        var i = n.getCurrentRpcUrl(),
            r = null,
            l = null,
            c = {},
            d = {},
            u = function(a) {
                if (null === r) try {
                    (r = e(i, { maxTimeout: 1, reconnectInterval: n.getWebSocketReconnectInterval() })).onMessage(function(e) {
                        if (e && e.data) {
                            ...
                            if (t) {
                                ...
                                if (a) {
                                    ...
                                    if (n) {
                                        var i = n.context;
                                        n.deferred.reject({ success: !1, context: i }), i.errorCallback && (o.debug("[aria2WebSocketRpcService.processRequestFailed] " + (i && i.requestBody && i.requestBody.method ? i.requestBody.method + " " : "") + "request failed"), i.errorCallback(i.id, { message: "Cannot connect to aria2!" })), delete c[a]
                                    }
                                }
                            }
                        }(e.request)
                    }), r.onOpen(function(e) { o.debug("[aria2WebSocketRpcService.onOpen] websocket is opened", e), a && a.connectionSuccessCallback && a.connectionSuccessCallback({ rpcUrl: i }) }), r.onClose(function(e) {
                        o.warn("[aria2WebSocketRpcService.onClose] websocket is closed", e);
                        var t = 0 < n.getWebSocketReconnectInterval();
                        t && g(a), t && a && a.connectionWaitingToReconnectCallback ? a.connectionWaitingToReconnectCallback({ rpcUrl: i }) : a && a.connectionFailedCallback && a.connectionFailedCallback({ rpcUrl: i })
                    })
                } catch (e) { return { success: !1, error: "Cannot initialize WebSocket!", exception: e } }
                return { success: !0, instance: r }
            },
            p = function(e) {
                if (e && r) {
                    for (var t in c)
                        if (c.hasOwnProperty(t)) {
                            var a = c[t];
                            a && (a.deferred.reject({ success: !1, context: a.context }), o.debug("[aria2WebSocketRpcService.reconnect] reject old request", a.context), a.context.errorCallback(a.context.id, { message: "Cannot connect to aria2!" })), delete c[t]
                        } e.connectionReconnectingCallback && e.connectionReconnectingCallback({ rpcUrl: i }), r.reconnect()
                }
            },
            g = function(e) { l ? o.warn("[aria2WebSocketRpcService.planToReconnect] another reconnection is pending") : (l = t(function() { return null == r ? o.warn("[aria2WebSocketRpcService.planToReconnect] websocket is null") : 0 === r.readyState || 1 === r.readyState ? o.warn("[aria2WebSocketRpcService.planToReconnect] websocket current state is already " + r.readyState) : p(e), void(l = null) }, n.getWebSocketReconnectInterval()), o.debug("[aria2WebSocketRpcService.planToReconnect] next reconnection is pending in " + n.getWebSocketReconnectInterval() + "ms")) };
        return {
            request: function(e) {
                if (e) {
                    var t = u({ connectionSuccessCallback: e.connectionSuccessCallback, connectionFailedCallback: e.connectionFailedCallback, connectionReconnectingCallback: e.connectionReconnectingCallback, connectionWaitingToReconnectCallback: e.connectionWaitingToReconnectCallback }),
                        a = e.uniqueId,
                        n = angular.toJson(e.requestBody);
                    o.debug("[aria2WebSocketRpcService.request] " + (e && e.requestBody && e.requestBody.method ? e.requestBody.method + " " : "") + "request start", e);
                    var i = s.defer();
                    return t.instance ? (c[a] = { context: e, deferred: i }, t.instance.send(n)) : (i.reject({ success: !1, context: e }), o.debug("[aria2WebSocketRpcService.request] client error", t), e.errorCallback(e.id, { message: t.error })), i.promise
                }
            },
            reconnect: function(e) { p(e) },
            on: function(e, t) {
                var a = d[e];
                angular.isArray(a) || (a = d[e] = []), a.push(t)
            }
        }
    }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2RpcService", ["$location", "$q", "aria2RpcConstants", "aria2RpcErrors", "aria2AllOptions", "ariaNgCommonService", "ariaNgLogService", "ariaNgSettingService", "aria2HttpRpcService", "aria2WebSocketRpcService", function(r, l, c, d, i, u, p, g, e, t) {
        var s = g.isCurrentRpcUseWebSocket() ? t : e,
            f = !1,
            m = g.getCurrentRpcSecret(),
            h = [],
            v = [],
            y = [],
            b = [],
            ...
            T = [],
            C = [],
            P = function(e) { return c.rpcServiceName + "." + e },
            D = function(e, t) {
                if (t) return e;
                var a = u.generateUniqueId(),
                    n = { uniqueId: a, requestBody: { jsonrpc: c.rpcServiceVersion, method: e.methodName, id: a, params: e.params }, connectionSuccessCallback: e.connectionSuccessCallback, connectionFailedCallback: e.connectionFailedCallback, connectionReconnectingCallback: e.connectionReconnectingCallback, connectionWaitingToReconnectCallback: e.connectionWaitingToReconnectCallback, successCallback: e.successCallback, errorCallback: e.errorCallback };
                return s.request(n)
            },
            R = function(e, a) {
                var t = P(e);
            ...
            O = function(e, t, a) { for (var n = [], i = !1, s = !1, o = [], r = 0; r < t.length; r++) t[r].callback = function(e) { o.push(e), i = i || e.success, s = s || !e.success }, n.push(e(t[r])); return l.all(n).finally(function() { a && a({ hasSuccess: !!i, hasError: !!s, results: o }) }) },
            N = function() {
                var e = arguments[0],
                    s = r.path(),
                    t = 0 === e.indexOf(c.rpcSystemServiceName + "."),
                    a = [],
                    n = { methodName: t ? e : P(e), connectionSuccessCallback: function() { A(b) }, connectionFailedCallback: function() { A(k) }, connectionReconnectingCallback: function() { A(w) }, connectionWaitingToReconnectCallback: function() { A(S) } };
                if (m && !t && a.push(c.rpcTokenPrefix + m), 1 < arguments.length) {
                    var o = arguments[1];
                    n.successCallback = function(e, t) {
                        if (o.callback && o.callback({ id: e, success: !0, data: t, context: o }), A(v), !f) {
                            f = !0;
                            var a = { rpcName: g.getCurrentRpcDisplayName() };
                            A(h, a)
                        }
                    }, n.errorCallback = function(e, t) {
                        var a, n = !1,
                            i = r.path();
                        o.silent || i !== s || (n = !(!(a = t) || !a.message || (p.error("[aria2RpcService.processError] " + a.message, a), d[a.message] && d[a.message].tipTextKey ? u.showError(d[a.message].tipTextKey) : u.showError(a.message), 0))), o.callback && o.callback({ id: e, success: !1, data: t, errorProcessed: n, context: o }), A(y)
                    }
                }
                if (2 < arguments.length)
                    for (var i = 2; i < arguments.length; i++) null !== arguments[i] && angular.isDefined(arguments[i]) && a.push(arguments[i]);
                return 0 < a.length && (n.params = a), n
            },
            I = function(e, t) { var a = angular.copy(e); for (var n in a) a.hasOwnProperty(n) && L(a, n) && (a[n] = F(a[n], i[n])); return t && t.pauseOnAdded && (a.pause = "true"), a },
            L = function(e, t) { return !(!e[t] || !angular.isString(e[t])) && !(!i[t] || "array" !== i[t].submitFormat) },
            F = function(e, t) {
                for (var a = e.split(t.separator), n = [], i = 0; i < a.length; i++) {
                    var s = a[i];
                    s && (s = s.replace("\r", ""), n.push(s))
                }
                return n
            };
        return R("onDownloadStart", a), R("onDownloadPause", n), R("onDownloadStop", o), R("onDownloadComplete", x), R("onDownloadError", T), R("onBtDownloadComplete", C), {
            getBasicTaskParams: function() { return ["gid", "totalLength", "completedLength", "uploadSpeed", "downloadSpeed", "connections", "numSeeders", "seeder", "status", "errorCode", "verifiedLength", "verifyIntegrityPending"] },
            getFullTaskParams: function() { var e = this.getBasicTaskParams(); return e.push("files"), e.push("bittorrent"), e.push("infoHash"), e },
            canReconnect: function() { return g.isCurrentRpcUseWebSocket() },
            reconnect: function(e) { p.info("[aria2RpcService.reconnect] reconnect now"), s.reconnect(N("", e)) },
            addUri: function(e, t) {
                var a = e.task ? e.task.urls : null,
                    n = I(e.task ? e.task.options : {}, e);
                return D(N("addUri", e, a, n), !!t)
            },
            addUriMulti: function(e) {
                for (var t = [], a = 0; a < e.tasks.length; a++) {
                    var n = e.tasks[a];
                    t.push({ silent: !!e.silent, task: n, pauseOnAdded: e.pauseOnAdded })
                }
                return O(this.addUri, t, e.callback)
            },
            addTorrent: function(e, t) {
                var a = e.task ? e.task.content : null,
                    n = I(e.task ? e.task.options : {}, e);
                return D(N("addTorrent", e, a, [], n), !!t)
            },
            addMetalink: function(e, t) {
                var a = e.task ? e.task.content : null,
                    n = I(e.task ? e.task.options : {}, e);
                return D(N("addMetalink", e, a, n), !!t)
            },
            remove: function(e, t) { return D(N("remove", e, e.gid), !!t) },
            forceRemove: function(e, t) { return D(N("forceRemove", e, e.gid), !!t) },
            forceRemoveMulti: function(e) { for (var t = [], a = 0; a < e.gids.length; a++) t.push({ silent: !!e.silent, gid: e.gids[a] }); return O(this.forceRemove, t, e.callback) },
            pause: function(e, t) { return D(N("pause", e, e.gid), !!t) },
            pauseAll: function(e, t) { return D(N("pauseAll", e), !!t) },
            forcePause: function(e, t) { return D(N("forcePause", e, e.gid), !!t) },
            forcePauseMulti: function(e) { for (var t = [], a = 0; a < e.gids.length; a++) t.push({ silent: !!e.silent, gid: e.gids[a] }); return O(this.forcePause, t, e.callback) },
            forcePauseAll: function(e, t) { return D(N("forcePauseAll", e), !!t) },
            unpause: function(e, t) { return D(N("unpause", e, e.gid), !!t) },
            unpauseMulti: function(e) { for (var t = [], a = 0; a < e.gids.length; a++) t.push({ silent: !!e.silent, gid: e.gids[a] }); return O(this.unpause, t, e.callback) },
            unpauseAll: function(e, t) { return D(N("unpauseAll", e), !!t) },
            tellStatus: function(e, t) { return D(N("tellStatus", e, e.gid), !!t) },
            getUris: function(e, t) { return D(N("getUris", e, e.gid), !!t) },
            getFiles: function(e, t) { return D(N("getFiles", e, e.gid), !!t) },
            getPeers: function(e, t) { return D(N("getPeers", e, e.gid), !!t) },
            getServers: function(e, t) { return D(N("getServers", e, e.gid), !!t) },
            tellActive: function(e, t) { return D(N("tellActive", e, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t) },
            tellWaiting: function(e, t) { return D(N("tellWaiting", e, angular.isDefined(e.offset) ? e.offset : 0, angular.isDefined(e.num) ? e.num : 1e3, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t) },
            tellStopped: function(e, t) { return D(N("tellStopped", e, angular.isDefined(e.offset) ? e.offset : -1, angular.isDefined(e.num) ? e.num : 1e3, angular.isDefined(e.requestParams) ? e.requestParams : null), !!t) },
            changePosition: function(e, t) { return D(N("changePosition", e, e.gid, e.pos, e.how), !!t) },
            changeUri: function(e, t) { return D(N("changeUri", e, e.gid, e.fileIndex, e.delUris, e.addUris), !!t) },
            getOption: function(e, t) { return D(N("getOption", e, e.gid), !!t) },
            changeOption: function(e, t) { var a = I(e.options, e); return D(N("changeOption", e, e.gid, a), !!t) },
            getGlobalOption: function(e, t) { return D(N("getGlobalOption", e), !!t) },
            changeGlobalOption: function(e, t) { var a = I(e.options, e); return D(N("changeGlobalOption", e, a), !!t) },
            getGlobalStat: function(e, t) { return D(N("getGlobalStat", e), !!t) },
            purgeDownloadResult: function(e, t) { return D(N("purgeDownloadResult", e), !!t) },
            removeDownloadResult: function(e, t) { return D(N("removeDownloadResult", e, e.gid), !!t) },
            removeDownloadResultMulti: function(e) { for (var t = [], a = 0; a < e.gids.length; a++) t.push({ silent: !!e.silent, gid: e.gids[a] }); return O(this.removeDownloadResult, t, e.callback) },
            getVersion: function(e, t) { return D(N("getVersion", e), !!t) },
            getSessionInfo: function(e, t) { return D(N("getSessionInfo", e), !!t) },
            shutdown: function(e, t) { return D(N("shutdown", e), !!t) },
            forceShutdown: function(e, t) { return D(N("forceShutdown", e), !!t) },
            saveSession: function(e, t) { return D(N("saveSession", e), !!t) },
            multicall: function(e, t) { return D(N("system.multicall", e, e.methods), !!t) },
            listMethods: function(e, t) { return D(N("system.listMethods", e), !!t) },
            listNotifications: function(e, t) { return D(N("system.listNotifications", e), !!t) },
            onFirstSuccess: function(e) { h.push(e.callback) },
            onOperationSuccess: function(e) { v.push(e.callback) },
            onOperationError: function(e) { y.push(e.callback) },
            onConnectionSuccess: function(e) { b.push(e.callback) },
            onConnectionFailed: function(e) { k.push(e.callback) },
            onConnectionReconnecting: function(e) { w.push(e.callback) },
            onConnectionWaitingToReconnect: function(e) { S.push(e.callback) },
            onDownloadStart: function(e) { a.push(e.callback) },
            onDownloadPause: function(e) { n.push(e.callback) },
            onDownloadStop: function(e) { o.push(e.callback) },
            onDownloadComplete: function(e) { x.push(e.callback) },
            onDownloadError: function(e) { T.push(e.callback) },
            onBtDownloadComplete: function(e) { C.push(e.callback) }
        }
    }])
}(),
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2TaskService", ["$q", "bittorrentPeeridService", "ariaNgConstants", "aria2Errors", "aria2RpcService", "ariaNgCommonService", "ariaNgLocalizationService", "ariaNgLogService", "ariaNgSettingService", function(u, m, l, b, p, k, w, S, g) {
        var x = function(e) {
                ...
                var i = t.substring(n + 1),
                    s = i.indexOf("?"),
                    o = i;
                if (0 < s && (o = i.substring(0, s)), a) try { o = decodeURI(o) } catch (e) { S.warn("[aria2TaskService.getFileName] failed to url decode file name, original file name: " + o, e) }
                return o
            },
            T = function(e, t) {
                var a = e.dir,
                ...
                var i = function() { 1 < n.length && n.charAt(0) === l.defaultPathSeparator && (n = n.substr(1)) };
                if (a && 0 === n.indexOf(a) && (n = n.substr(a.length)), i(), e.bittorrent && "multi" === e.bittorrent.mode && e.bittorrent.info && e.bittorrent.info.name) {
                    var s = e.bittorrent.info.name;
                    0 === n.indexOf(s) && (n = n.substr(s.length))
                }
                return i(), t.fileName && n.lastIndexOf(t.fileName) + t.fileName.length === n.length && (n = n.substr(0, n.length - t.fileName.length)), 1 < n.length && n.charAt(n.length - 1) === l.defaultPathSeparator && (n = n.substr(0, n.length - 1)), n
            },
            c = function(e, t, a) {
                var n = a[e];
                if (n) return n;
                ...
                return n = { isDir: !0, nodePath: e, nodeName: s, relativePath: i && i.nodePath || "", level: i && i.level + 1 || 0, length: 0, selected: !0, partialSelected: !1, files: [], subDirs: [] }, t.push(n), a[e] = n, i && i.subDirs.push(n), n
            },
            C = function(e, t, a) {
                if (e && t && a) {
            ...
            P = function(e, t, a) {
                if (e) {
                    ...
                    e.length = n, e.selected = 0 < i && i === e.subDirs.length + e.files.length, e.partialSelected = 0 < i && i < e.subDirs.length + e.files.length || 0 < s
                }
            },
            D = function(e, t) {
            ...
            r = function(e, t) {
                ...
                e.totalLength = parseInt(e.totalLength), e.completedLength = parseInt(e.completedLength), e.completePercent = 0 < e.totalLength ? e.completedLength / e.totalLength * 100 : 0, e.remainLength = e.totalLength - e.completedLength, e.remainPercent = 100 - e.completePercent, e.uploadLength = e.uploadLength ? parseInt(e.uploadLength) : 0, e.shareRatio = 0 < e.completedLength ? e.uploadLength / e.completedLength : 0, e.uploadSpeed = parseInt(e.uploadSpeed), e.downloadSpeed = parseInt(e.downloadSpeed), e.numPieces = parseInt(e.numPieces), e.completedPieces = k.countArray(i, !0), e.pieceLength = parseInt(e.pieceLength), e.idle = 0 === e.downloadSpeed, e.remainTime = (a = e.remainLength, 0 === (n = e.downloadSpeed) ? 0 : a / n), e.seeder = !0 === e.seeder || "true" === e.seeder, e.verifiedLength && e.totalLength ? e.verifiedPercent = parseInt(e.verifiedLength / e.totalLength * 100) : e.verifiedPercent = void 0;
                var s, o, r, l, c = (r = !(o = ""), (s = e).bittorrent && s.bittorrent.info && (o = s.bittorrent.info.name), !o && s.files && 0 < s.files.length && (o = x(s.files[0])), o || (o = w.getLocalizedText("Unknown"), r = !1), { name: o, success: r });
                if (e.taskName = c.name, e.hasTaskName = c.success, e.errorDescription = (l = e).errorCode && b[l.errorCode] && b[l.errorCode].descriptionKey ? b[l.errorCode].hide ? "" : b[l.errorCode].descriptionKey : "", e.files) {
                    for (var d = 0, u = [], p = {}, g = 0; g < e.files.length; g++) {
                        var f = e.files[g];
                        if (f.index = parseInt(f.index), f.fileName = x(f), f.length = parseInt(f.length), f.selected = !0 === f.selected || "true" === f.selected, f.completedLength = parseInt(f.completedLength), f.completePercent = 0 < f.length ? f.completedLength / f.length * 100 : 0, t) {
                ...
                if (e.files && 1 === e.files.length && e.files[0].uris && e.files[0].uris[0]) {
                    var v = !0,
                        y = e.files[0].uris[0].uri;
                    for (g = 0; g < e.files[0].uris.length; g++) { if (e.files[0].uris[g].uri !== y) { v = !1; break } } v && (e.singleUrl = y)
                }
            ...
            d = function(e, t, a) {
                ...
                for (var n = D(t.bitfield, t.numPieces), i = k.countArray(n, !0), s = t.completePercent, o = 0; o < e.length; o++) {
                    var r = e[o],
                        ...
                        u = k.countArray(d, !0);
                    if (r.name = r.ip + ":" + r.port, r.completePercent = u / t.numPieces * 100, r.downloadSpeed = l, r.uploadSpeed = c, r.seeder = !0 === r.seeder || "true" === r.seeder, u === i && r.completePercent !== s && (r.completePercent = s), r.peerId) {
                        var p = k.decodePercentEncodedString(r.peerId),
                            g = p ? m.parseClient(p) : null;
                        if (g && "unknown" !== g.client) {
                            var f = { name: g.client ? g.client.trim() : "", version: g.version ? g.version.trim() : "" };
            ...
            t = function(a, n, i) {
                return function(e) {
                    ...
                    e && e.gid ? a(e.gid, function(e) { t.task = e.success ? e.data : null, n(t) }, !0) : n(t)
                }
            },
            h = function(e) { return { local: !0, bitfield: e.bitfield, completePercent: e.completePercent, downloadSpeed: e.downloadSpeed, name: "(local)", seeder: e.seeder, uploadSpeed: e.uploadSpeed } };
        return {
            getTaskList: function(e, t, a, n) {
                ...
                return i({ requestWholeInfo: t, requestParams: t ? p.getFullTaskParams() : p.getBasicTaskParams(), silent: !!n, callback: function(e) { a ? a(e) : S.warn("[aria2TaskService.getTaskList] callback is null") } })
            },
            getTaskStatus: function(e, t, a, n) { return p.tellStatus({ gid: e, silent: !!a, callback: function(e) { t ? (e.success && r(e.data, n), t(e)) : S.warn("[aria2TaskService.getTaskStatus] callback is null") } }) },
            getTaskOptions: function(e, t, a) { return p.getOption({ gid: e, silent: !!a, callback: t }) },
            setTaskOption: function(e, t, a, n, i) { var s = {}; return s[t] = a, p.changeOption({ gid: e, options: s, silent: !!i, callback: n }) },
            selectTaskFile: function(e, t, a, n) { for (var i = "", s = 0; s < t.length; s++) 0 < i.length && (i += ","), i += t[s]; return this.setTaskOption(e, "select-file", i, a, n) },
            getBtTaskPeers: function(t, a, e, n) { return p.getPeers({ gid: t.gid, silent: !!e, callback: function(e) { a ? (e.success && d(e.data, t, n), a(e)) : S.warn("[aria2TaskService.getBtTaskPeers] callback is null") } }) },
            getTaskStatusAndBtPeers: function(e, t, a, n, i, s) { var o = [p.tellStatus({ gid: e }, !0)]; return n && o.push(p.getPeers({ gid: e }, !0)), p.multicall({ methods: o, silent: !!a, callback: function(e) { t ? (e.task = {}, e.success && 0 < e.data.length && (e.task = e.data[0][0], r(e.task, s)), e.success && e.task.bittorrent && 1 < e.data.length && (e.peers = e.data[1][0], d(e.peers, e.task, i)), t(e)) : S.warn("[aria2TaskService.getTaskStatusAndBtPeers] callback is null") } }) },
            newUriTask: function(e, t, a, n) { return p.addUri({ task: e, pauseOnAdded: !!t, silent: !!n, callback: a }) },
            newUriTasks: function(e, t, a, n) { return p.addUriMulti({ tasks: e, pauseOnAdded: !!t, silent: !!n, callback: a }) },
            newTorrentTask: function(e, t, a, n) { return p.addTorrent({ task: e, pauseOnAdded: !!t, silent: !!n, callback: a }) },
            newMetalinkTask: function(e, t, a, n) { return p.addMetalink({ task: e, pauseOnAdded: !!t, silent: !!n, callback: a }) },
            startTasks: function(e, t, a) { return p.unpauseMulti({ gids: e, silent: !!a, callback: t }) },
            pauseTasks: function(e, t, a) { return p.forcePauseMulti({ gids: e, silent: !!a, callback: t }) },
                ...
                return p.multicall({
                    ...
                    callback: function(e) {
                        if (o) {
                            ...
                            if (0 < e.data.length && (c = e.data[0][0]), 1 < e.data.length && (d = e.data[1][0]), !c || !d || !c.files || 1 !== c.files.length || c.bittorrent) return c || S.warn("[aria2TaskService.retryTask] task is null"), d || S.warn("[aria2TaskService.retryTask] options is null"), c.files || S.warn("[aria2TaskService.retryTask] task file is null"), 1 !== c.files.length && S.warn("[aria2TaskService.retryTask] task file length is not equal 1"), c.bittorrent && S.warn("[aria2TaskService.retryTask] task is bittorrent"), l.reject(s), void o({ success: !1 });
                            ...
                            p.addUri({
                                ...
                                callback: function(e) {
                                    ...
                                    g.getRemoveOldTaskAfterRetrying() && p.removeDownloadResult({ gid: s, silent: !0, callback: function(e) { e.success || S.warn("[aria2TaskService.retryTask] removeDownloadResult response is not success", e) } }), l.resolve(e), o(e)
                                }
                            })
            ...
            retryTasks: function(i, s, e) {
                if (s) {
                    for (var t = this.retryTask, o = u.defer(), a = null, r = 0, l = 0, n = function(a, n) {
                            return S.debug("[aria2TaskService.retryTasks] task#" + n + ", gid=" + a.gid + " start retrying", a), t(a.gid, function(e) {
                                if (S.debug("[aria2TaskService.retryTasks] task#" + n + ", gid=" + a.gid + ", result=" + e.success, a), e.success ? r++ : l++, r + l === i.length) {
                                    var t = { successCount: r, failedCount: l, hasSuccess: 0 < r, hasError: 0 < l };
                                    o.resolve(t), s(t)
                                }
                            }, e)
                        }, c = 0; c < i.length; c++) {
                        var d = i[c];
                        a = a ? function(e, t) { return a.then(function() { return n(e, t) }).catch(function() { return n(e, t) }) }(d, c) : n(d, c)
                    }
                    return o.promise
                }
            ...
            removeTasks: function(e, t, a) {
                for (var n = [], i = [], s = 0; s < e.length; s++) "complete" === e[s].status || "error" === e[s].status || "removed" === e[s].status ? i.push(e[s].gid) : n.push(e[s].gid);
                var o = [],
                    r = !1,
                    l = !1,
                    c = [];
                return 0 < n.length && o.push(p.forceRemoveMulti({ gids: n, silent: !!a, callback: function(e) { k.pushArrayTo(c, e.results), r = r || e.hasSuccess, l = l || e.hasError } })), 0 < i.length && o.push(p.removeDownloadResultMulti({ gids: i, silent: !!a, callback: function(e) { k.pushArrayTo(c, e.results), r = r || e.hasSuccess, l = l || e.hasError } })), u.all(o).then(function() { t && t({ hasSuccess: !!r, hasError: !!l, results: c }) })
            },
            changeTaskPosition: function(e, t, a, n) { return p.changePosition({ gid: e, pos: t, how: "POS_SET", silent: !!n, callback: a }) },
            clearStoppedTasks: function(e, t) { return p.purgeDownloadResult({ silent: !!t, callback: e }) },
            onConnectionSuccess: function(e) { e ? p.onConnectionSuccess({ callback: e }) : S.warn("[aria2TaskService.onConnectionSuccess] callback is null") },
            onConnectionFailed: function(e) { e ? p.onConnectionFailed({ callback: e }) : S.warn("[aria2TaskService.onConnectionFailed] callback is null") },
            onConnectionReconnecting: function(e) { e ? p.onConnectionReconnecting({ callback: e }) : S.warn("[aria2TaskService.onConnectionReconnecting] callback is null") },
            onConnectionWaitingToReconnect: function(e) { e ? p.onConnectionWaitingToReconnect({ callback: e }) : S.warn("[aria2TaskService.onConnectionWaitingToReconnect] callback is null") },
            onFirstSuccess: function(e) { e ? p.onFirstSuccess({ callback: e }) : S.warn("[aria2TaskService.onFirstSuccess] callback is null") },
            onOperationSuccess: function(e) { e ? p.onOperationSuccess({ callback: e }) : S.warn("[aria2TaskService.onOperationSuccess] callback is null") },
            onOperationError: function(e) { e ? p.onOperationError({ callback: e }) : S.warn("[aria2TaskService.onOperationError] callback is null") },
            onTaskCompleted: function(e) { e ? p.onDownloadComplete({ callback: t(this.getTaskStatus, e, "completed") }) : S.warn("[aria2TaskService.onTaskCompleted] callback is null") },
            onBtTaskCompleted: function(e) { e ? p.onBtDownloadComplete({ callback: t(this.getTaskStatus, e, "btcompleted") }) : S.warn("[aria2TaskService.onBtTaskCompleted] callback is null") },
            onTaskErrorOccur: function(e) { e ? p.onDownloadError({ callback: t(this.getTaskStatus, e, "error") }) : S.warn("[aria2TaskService.onTaskErrorOccur] callback is null") },
            ...
            getPieceStatus: function(e, t) { return D(e, t) },
            ...
            estimateHealthPercentFromPeers: function(e, t) {
                if (!e || e.numPieces < 1 || t.length < 1) return S.warn("[aria2TaskService.estimateHealthPercentFromPeers] tasks is null or numPieces < 1 or peers < 1", e), e.completePercent;
                ...
                var u = 0;
                if (0 < a.length)
                    for (;;) { var p = !0; for (s = 0; s < a.length; s++) 0 < a[s] ? (u++, a[s]--) : p = !1; if (!p) break }
                if (u <= n) return i;
...
function() {
    "use strict";
    angular.module("ariaNg").factory("aria2SettingService", ["ariaNgConstants", "aria2AllOptions", "aria2GlobalAvailableOptions", "aria2QuickSettingsAvailableOptions", "aria2TaskAvailableOptions", "aria2RpcService", "ariaNgLogService", "ariaNgStorageService", function(o, p, t, a, r, s, n, l) {
        var c = function(e) { return o.settingHistoryKeyPrefix + "." + e };
        return {
            isOptionKeyValid: function(e) { return !!p[e] },
            isOptionKeyRequired: function(e) { var t = p[e]; return t && t.required },
            getAvailableGlobalOptionsKeys: function(e) { return "basic" === e ? t.basicOptions : "http-ftp-sftp" === e ? t.httpFtpSFtpOptions : "http" === e ? t.httpOptions : "ftp-sftp" === e ? t.ftpSFtpOptions : "bt" === e ? t.btOptions : "metalink" === e ? t.metalinkOptions : "rpc" === e ? t.rpcOptions : "advanced" === e && t.advancedOptions },
            getAria2QuickSettingsAvailableOptions: function(e) { return "globalSpeedLimit" === e && a.globalSpeedLimitOptions },
            getAvailableTaskOptionKeys: function(e, t) {
                for (var a = r.taskOptions, n = [], i = 0; i < a.length; i++) {
                    var s = a[i],
                        o = { key: s.key, category: s.category };
                    s.canShow && s.canShow.indexOf(e) < 0 || ("http" === s.category && t || ("bittorrent" !== s.category || t) && (s.canUpdate && s.canUpdate.indexOf(e) < 0 && (o.readonly = !0), n.push(o)))
                }
                return n
            },
            getNewTaskOptionKeys: function() {
                for (var e = r.taskOptions, t = [], a = 0; a < e.length; a++) {
                    var n = e[a],
                        i = { key: n.key, category: n.category, showHistory: n.showHistory };
            ...
            getSpecifiedOptions: function(e, t) {
                ...
                for (var n = 0; n < e.length; n++) {
                    ...
                    var c = p[i];
                    if (c) {
                        if (c = angular.extend({ key: i, nameKey: "options." + i + ".name", descriptionKey: "options." + i + ".description" }, c), o && (c.category = o), "boolean" === c.type && (c.options = ["true", "false"]), s && (c.readonly = !0), r && (c.showHistory = !0), t && t.disableRequired && (c.required = !1), c.options) {
                            for (var d = [], u = 0; u < c.options.length; u++) d.push({ name: "option." + c.options[u], value: c.options[u] });
                            c.options = d
                        }
                        a.push(c)
                    }
            ...
            getSettingHistory: function(e) { if (!this.isOptionKeyValid(e)) return []; for (var t = c(e), a = l.get(t) || [], n = [], i = 0; i < Math.min(a.length, o.historyMaxStoreCount); i++) n.push(a[i]); return n },
...
angular.module("ariaNg").run(["$templateCache", function(e) { 
    ...
    e.put("views/settings-aria2.html", '<section class="content no-padding"><div class="settings-table striped hoverable"><ng-setting ng-repeat="option in context.availableOptions" option="option" ng-model="context.globalOptions[option.key]" default-value="option.defaultValue" error-tooltip-placement="{{$index > 0 ? \'top\': \'bottom\'}}" on-change-value="setGlobalOption(key, value, optionStatus)"></ng-setting></div></section>'), 
